...
class ResultCard extends StatelessWidget {
  ...
  String get _line {
    ...
    final ways = play.day.ways;
    return '${play.day.ask} bookings and not a clash among '
        'them$asked. The sweep says no book holds more, and counts '
        '${ways == 1 ? 'this the only full one' : '$ways full ones'}.';
  }
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Expanded(child: _Button(label: 'Days', onTap: onLeave)),
                  const SizedBox(width: 9),
                  Expanded(
        ...
        child: GestureDetector(
          ...
          child: ExcludeSemantics(
            child: Container(
              height: 44,
              decoration: BoxDecoration(
                color: lit ? Palette.edge : Palette.ledger,
