...
import 'package:hirebeck/ui/mark.dart';
import 'package:hirebeck/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the busy day, its one full book kept', () {
    // The pictured bookings go through the same code a finger goes
    // through, so the logo is a live game, not an arrangement.
    final play = Mark.kept;
    expect(play.isDone, isTrue);
    expect(play.clashes, isEmpty);
    expect(play.bookedCount, 5);
  });
