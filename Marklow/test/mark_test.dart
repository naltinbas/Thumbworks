...
import 'package:marklow/ui/mark.dart';
import 'package:marklow/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the square graced', () {
    // The picture is a real graceful square, found by the sweep
    // and checked here.
    final play = Mark.square;
    expect(play.isDone, isTrue);
    expect(play.gaps.toSet(), {1, 2, 3, 4});
  });
