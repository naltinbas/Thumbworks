...
import 'low_screen.dart';
import 'mark.dart';
import 'palette.dart';

/// The fence, stile by low.
          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Number the posts so the gaps run 1, 2, 3 and '
                  'up: the five-ring never graces.',
              ...
              Expanded(
                child: ListView.builder(
                  itemCount: Lows.count,
                  itemBuilder: (context, number) {
                    final low = Lows.at(number);
                    final fewest = Best.fewest(low.name);
                    return ListTile(
                      leading: Text(
                        '${number + 1}',
