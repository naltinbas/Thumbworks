          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Eight signal lamps down the valley. Light them so the '
                  'places of the lit ones add to nothing over nine, and any '
                  'one lamp can go out without the message being lost.',
                      ...
                      onTap: () async {
                        await Navigator.of(context).push(
                          MaterialPageRoute<void>(
                            builder: (_) => LampScreen(level: level),
                          ),
                        );
                        if (mounted) setState(() {});
                      },
