...
import 'package:watchmere/ui/mark.dart';
import 'package:watchmere/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the pinch, real and checked', () {
    // The picture is three watches meeting in a single gold
    // hour, the full ring pinched to its point.
    final play = Mark.pinch;
