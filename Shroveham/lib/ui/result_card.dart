...
class ResultCard extends StatelessWidget {
  ...
  String get _line {
    if (play.isFewest) {
      return 'Served on ${play.made} flips, and fewer cannot do it.';
    }
    return 'Served on ${play.made} flips. It can be done on '
        '${play.batch.fewest}.';
  }
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Expanded(child: _Button(label: 'Batches', onTap: onLeave)),
                  const SizedBox(width: 9),
                  Expanded(
        ...
        child: GestureDetector(
          ...
          child: ExcludeSemantics(
            child: Container(
              height: 44,
              decoration: BoxDecoration(
                color: lit ? Palette.edge : Palette.iron,
