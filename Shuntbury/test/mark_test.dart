...
import 'package:shuntbury/ui/mark.dart';
import 'package:shuntbury/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the swapped pair, real and checked', () {
    // The picture is home with the 7 and the 8 swapped: one pair out of
    // order, and the walk from home never reaches it.
    final play = Mark.swapped;
    expect(play.yard, [1, 2, 3, 4, 5, 6, 8, 7, 0]);
    expect(play.inversions, 1);
    expect(Rules.reachable(play.yard), isFalse);
