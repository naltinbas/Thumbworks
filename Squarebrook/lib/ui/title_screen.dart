...
import 'mark.dart';
import 'palette.dart';
import 'stones_screen.dart';

/// The sham, number by number.
          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Square flagstones to make a number of: every number is four '
                  'squares at most, and seven is never three, since a square '
                  'leaves nought, one or four by eight and no three of those '
                  'make seven.',
