...
import 'package:squarebrook/ui/mark.dart';
import 'package:squarebrook/ui/palette.dart';
...
void main() {
  ...
  test('the mark is ninety-nine made, real and checked', () {
    // The picture is one, forty-nine and forty-nine standing on the
    // ground: ninety-nine of three squares.
    final play = Mark.ninetyNine;
    expect(play.isDone, isTrue);
    expect(play.picked, [1, 49, 49]);
  });
