...
import 'package:weaveholme/ui/mark.dart';
import 'package:weaveholme/ui/palette.dart';
...
void main() {
  ...
  test('the mark is Sylvester\'s eight, real and checked', () {
    // The picture is the eight by eight plaid with every two rows
    // agreeing in four.
    final play = Mark.sylvester;
    expect(play.isDone, isTrue);
    expect(play.uneven, isEmpty);
  });
