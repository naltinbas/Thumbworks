...
import 'mark.dart';
import 'palette.dart';
import 'plaid_screen.dart';

/// The sham, plaid by plaid.
          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'A plaid of light and dark squares where every two rows '
                  'agree in exactly half their squares: two, four and eight '
                  'weave, and six never, since two rows against a third agree '
                  'in an even count.',
