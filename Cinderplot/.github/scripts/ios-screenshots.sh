#!/usr/bin/env bash
#
# Plays a board on a booted simulator and keeps the pictures. Same two kinds as
# the Android run: the ones the test asks the framework for, and sampled ones
# off the simulator screen that are allowed to fail.
#
...
udid="$1"
bundle=dev.cinderplot.cinderplot
