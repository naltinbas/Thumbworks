...
String whyWords(Play play) {
  ...
  return 'Six wagons stand on the main line in the order 1 to 6 and leave by '
      ...
      'the siding, b before c since they were shunted in order. That puts c '
      'nearer the points than b, so c has to leave first, and it does. But b '
      'is bigger than c and left after it, which the yard has just been shown '
      'to forbid. So no out-train holds a wagon, then a smaller one, then one '
      'in between: no train of the shape 3, 1, 2.\n\n'
