          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Six wagons and one siding: shunt them and send them out '
                  'in any order you like, so long as it is an order a single '
                  'siding can make. Most orders it cannot.',
                      ...
                      onTap: () async {
                        await Navigator.of(context).push(
                          MaterialPageRoute<void>(
                            builder: (_) => YardScreen(level: level),
                          ),
                        );
                        if (mounted) setState(() {});
                      },
