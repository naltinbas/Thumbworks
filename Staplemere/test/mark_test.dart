...
import 'package:staplemere/ui/mark.dart';
import 'package:staplemere/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the hoarded fit done in its fewest piles', () {
    // Every bale goes down where the snug fit puts it, through the same
    // code a finger goes through, so the picture is a morning done right.
    final play = Mark.done;
    expect(play.isDone, isTrue);
    expect(play.standing, play.deal.fewest);
