...
/// The card under a morning with every bale down.
class ResultCard extends StatelessWidget {
  ...
  String get _line {
    ...
    if (play.isFewest) {
      return 'Every bale down in $standing piles, and fewer cannot take '
          'this morning.';
    }
    return 'Every bale down in $standing piles. It can be done in '
        '${play.deal.fewest}.';
  }
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Expanded(child: _Button(label: 'Deals', onTap: onLeave)),
                  const SizedBox(width: 9),
                  Expanded(
        ...
        child: GestureDetector(
          ...
          child: ExcludeSemantics(
            child: Container(
              height: 44,
              decoration: BoxDecoration(
                color: lit ? Palette.edge : Palette.yard,
