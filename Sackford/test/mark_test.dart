...
import 'package:sackford/ui/mark.dart';
import 'package:sackford/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the three carts full, real and checked', () {
    // The picture is the one loading of six, five, five, four, four,
    // four and two into three carts, every cart at ten.
    final play = Mark.three;
    expect(play.loads, [10, 10, 10]);
