...
import 'package:tuesleigh/ui/mark.dart';
import 'package:tuesleigh/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the Tuesday grid, real and checked', () {
    // The picture is the fourteen-by-fourteen grid under seven tags, the
    // twenty-seven told families lit and thirteen of them gold: 13/27.
    final play = Mark.tuesday;
    expect(play.tags, 7);
    expect((play.told, play.bothBoys), (27, 13));
    expect(play.chance, Frac.of(13, 27));
