...
import 'package:quayfleet/ui/mark.dart';
import 'package:quayfleet/ui/palette.dart';
...
void main() {
  ...
  test('the mark is a day really worked, up to the most there is', () {
    // Berthed through the same code a finger goes through, so the picture is
    // a day the game would call over, on as many ships as the berth will
    // take.
    final play = Mark.worked;
    expect(play.isDone, isTrue);
    expect(play.isMost, isTrue);
    expect(Mark.quay.allFit(play.taken), isTrue);
  });
