...
import 'mark.dart';
import 'palette.dart';
import 'plait_screen.dart';

/// The rope walk, ask by ask.
          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: SizedBox(height: 128, child: Mark()),
              ),
              const Text(
                'Plaitwell',
                style: TextStyle(
              ...
              const Padding(
                ...
                child: Text(
                  'Paint the ropes of a plait so every crossing shows one '
                  'colour or three. What you can paint says what knot you '
                  'are holding.',
                      ...
                      onTap: () async {
                        await Navigator.of(context).push(
                          MaterialPageRoute<void>(
                            builder: (_) => PlaitScreen(level: level),
                          ),
                        );
                        if (mounted) setState(() {});
                      },
