...
import 'package:wedgeworth/ui/mark.dart';
import 'package:wedgeworth/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the icosahedron\'s corner, real and checked', () {
    // The picture is five triangles round a point, 300 degrees, with
    // sixty to spare.
    final play = Mark.icosahedron;
    expect(play.sides, 3);
    expect(play.faces, 5);
    expect(play.sum, (900, 3));
    expect(play.gap, (180, 3));
    expect(play.closes, isTrue);
    expect(play.solid, 'the icosahedron');
