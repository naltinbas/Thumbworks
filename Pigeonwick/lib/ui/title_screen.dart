          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Post every letter to the wrong hole: the '
                  'postman\'s arithmetic never misses.',
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, number) {
                    ...
                    final fewest = Best.fewest(round.name);
                    return ListTile(
                      leading: Text(
                        '${number + 1}',
                      ...
                      onTap: () async {
                        await Navigator.of(context).push(
                          MaterialPageRoute<void>(
                            builder: (_) => PostScreen(round: round),
                          ),
                        );
                        if (mounted) setState(() {});
                      },
