...
import 'package:pigeonwick/ui/mark.dart';
import 'package:pigeonwick/ui/palette.dart';
...
void main() {
  ...
  test('the mark is one of the nine', () {
    // The picture is a real all-wrong round of four, found by
    // the sweep and checked here.
    final play = Mark.nine;
    expect(play.isDone, isTrue);
    expect(play.homes, isEmpty);
    expect(play.allPosted, isTrue);
  });
