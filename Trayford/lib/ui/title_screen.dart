          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Fill the tray to a count that leaves the right eggs '
                  'over by threes, by fives and by sevens.',
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, number) {
                    ...
                    final fewest = Best.fewest(tray.name);
                    return ListTile(
                      leading: Text(
                        '${number + 1}',
                      ...
                      subtitle: Text(
                        '${tray.task[0].toUpperCase()}${tray.task.substring(1)}'
