...
import 'package:trayford/ui/mark.dart';
import 'package:trayford/ui/palette.dart';
...
void main() {
  ...
  test('the mark is Sun Tzu\'s count, real and checked', () {
    // The picture is twenty-three eggs, two over by threes, three by
    // fives, two by sevens.
    final play = Mark.oldCount;
