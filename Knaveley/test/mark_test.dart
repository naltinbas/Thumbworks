...
import 'package:knaveley/ui/mark.dart';
import 'package:knaveley/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the naming that holds the second ask', () {
    final play = Mark.named;
    expect(play.kinds, [false, true, false]);
    expect(play.caught, isEmpty);
    expect(play.isDone, isTrue);
    expect(Rules.consistent(play.level.tellings, play.kinds), isTrue);
    expect(play.level.answers.single, play.kinds);
  });
