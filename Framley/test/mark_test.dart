...
import 'package:framley/ui/mark.dart';
import 'package:framley/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the wall of nine, hung, real and checked', () {
    // The picture is the search's first hanging of Moron's rectangle.
    final play = Mark.nine;
    expect(play.isDone, isTrue);
    expect(play.bareCells, 0);
    expect(play.hung.length, 9);
    expect(play.hung[18], (0, 0));
    expect(play.hung[1], (22, 24));
  });
