...
import 'package:halfstead/ui/mark.dart';
import 'package:halfstead/ui/palette.dart';
...
void main() {
  ...
  test('the mark is seven halvings, real and checked', () {
    // The picture is the corridor with seven hops, 127/128 covered and
    // 1/128 to go: The Hundredth's aim.
    final play = Mark.seven;
    expect((play.shareIndex, play.steps), (0, 7));
    expect(play.covered, Frac.of(127, 128));
    expect(play.left, Frac.of(1, 128));
    expect(Rules.tell(play.lengths.last), '1/128');
    expect(play.isDone, isTrue);
    expect(Levels.at(0).aim, (Frac.of(1, 2), 7));
  });
