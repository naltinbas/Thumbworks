...
import 'package:mitrewick/ui/mark.dart';
import 'package:mitrewick/ui/palette.dart';
...
void main() {
  ...
  test('the mark is six bishops at peace on the four, real and checked', () {
    // The picture is the sweep's first peaceful six: four along the
    // top and two along the bottom, six rising diagonals used.
    final play = Mark.six;
    expect(play.isDone, isTrue);
    expect(play.risingUsed, 6);
  });
