          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Eight boxes laid in a staircase, and a hook written in '
                  'each one. Count the ways to number them and it is always '
                  'eight factorial over the hooks multiplied.',
                      ...
                      onTap: () async {
                        await Navigator.of(context).push(
                          MaterialPageRoute<void>(
                            builder: (_) => ShapeScreen(level: level),
                          ),
                        );
                        if (mounted) setState(() {});
                      },
