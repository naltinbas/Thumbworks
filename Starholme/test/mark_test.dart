...
import 'package:starholme/ui/mark.dart';
import 'package:starholme/ui/palette.dart';
...
void main() {
  ...
  test('the mark is a nine round, real and checked', () {
    // The picture is a closed nine on the star, one post
    // standing out alone.
