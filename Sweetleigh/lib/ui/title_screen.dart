          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Cut the string of sweets and hand the pieces out '
                  'in turn: each child gets half of every kind.',
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, number) {
                    ...
                    final fewest = Best.fewest(share.name);
                    return ListTile(
                      leading: Text(
                        '${number + 1}',
                      ...
                      subtitle: Text(
                        '${share.task[0].toUpperCase()}${share.task.substring(1)}'
