...
import 'package:sweetleigh/ui/mark.dart';
import 'package:sweetleigh/ui/palette.dart';
...
void main() {
  ...
  test('the mark is reds-then-blues shared by the window, real and checked', () {
    // The picture is the two cuts round the middle four, built by
    // the window and fair.
    final play = Mark.twoCuts;
    expect(play.isDone, isTrue);
    expect(play.cuts, [2, 6]);
  });
