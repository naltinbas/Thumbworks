          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Planarity on the village green: move the hamlets until no '
                  'two lanes cross, every placing on the grid swept, and the '
                  'three laned to the three never clear, by Euler.',
