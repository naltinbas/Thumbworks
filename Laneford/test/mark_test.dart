...
import 'package:laneford/ui/mark.dart';
import 'package:laneford/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the four hamlets laid clear, real and checked', () {
    // The picture is the sweep's first clear placing of four hamlets
    // each laned to each: one inside the triangle of the other three.
    final play = Mark.four;
    expect(play.at, [(0, 0), (2, 0), (1, 1), (1, 2)]);
