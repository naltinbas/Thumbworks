...
import 'package:winnowmere/ui/mark.dart';
import 'package:winnowmere/ui/palette.dart';
...
void main() {
  ...
  test('the mark is a network that really sorts', () {
    // Built through the same code a finger goes through, so the picture is a
    // network that sorts every row there is in the fewest there are.
    final play = Mark.sorting;
    expect(play.isDone, isTrue);
    expect(play.isTight, isTrue);
    expect(play.count, Mark.sifting.fewest);
  });
