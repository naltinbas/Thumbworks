...
import 'package:rimsbury/ui/mark.dart';
import 'package:rimsbury/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the equal coins and the heart, real and checked', () {
    // The picture is a hoop of three and a roller of three round the
    // outside, two turns a trip, the mark's path the cardioid; The
    // Twice's own landing.
    final play = Mark.heart;
    expect((play.hoop, play.coin, play.inside), (3, 3, false));
