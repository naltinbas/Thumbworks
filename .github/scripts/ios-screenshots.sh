#!/usr/bin/env bash
#
# Draws a line on a booted simulator and keeps the pictures. Same two kinds as
# the Android run: the named ones the test asks the framework for, and sampled
# ones off the simulator screen that are allowed to fail.
#
