...
import 'package:fevershaw/ui/mark.dart';
import 'package:fevershaw/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the one-in-a-hundred village, real and checked', () {
    // The picture is the fever one in a hundred and the test ninety-nine
    // in a hundred both ways: the flagged half ill.
    final play = Mark.hundred;
    expect(play.oneIn, 100);
    expect(play.catchRate, (99, 100));
    expect(play.alarm, (1, 100));
