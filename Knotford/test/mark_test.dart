...
import 'package:knotford/ui/mark.dart';
import 'package:knotford/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the twelve-knot rope squared, real and checked', () {
    // The picture is the rope-stretchers' rope: pegs at knots 3 and 7,
    // sides 3, 4 and 5, the corner square.
    final play = Mark.twelve;
