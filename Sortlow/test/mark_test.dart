...
import 'package:sortlow/ui/mark.dart';
import 'package:sortlow/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the classic road, real and checked', () {
    // The picture is 3524 grinding home in three turns, the
    // stone arriving in gold.
