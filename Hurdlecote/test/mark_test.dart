...
import 'package:hurdlecote/ui/mark.dart';
import 'package:hurdlecote/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the full fold standing', () {
    // The mark goes through the same code a finger goes through, so
    // the picture is a fence that settles its own green.
    final play = Mark.opening;
    expect(play.green.name, 'The Full Fold');
    expect(play.isDone, isTrue);
    expect(play.pens, 6);
    expect(play.swallows, 2);
  });
