...
import 'package:glintmere/ui/mark.dart';
import 'package:glintmere/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the bounce with matching angles', () {
    // The one peg where the angle in matches the angle out, whose two
    // legs are five paces each and come to the straight run of ten.
    final mark = Mark.shot;
    expect(mark.bounce, 5);
    expect(mark.even, isTrue);
    expect(mark.straight, isTrue);
    expect(mark.paces, Level.least);
    final (one, two) = mark.legs;
