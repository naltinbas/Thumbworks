...
import 'mark.dart';
import 'palette.dart';
import 'glint_screen.dart';

/// The mirror, ask by ask.
          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Slide the bounce along the mirror. The shortest path '
                  'from the lamp to the eye is the one where the angle in '
                  'matches the angle out, and nothing beats it.',
                      ...
                      onTap: () async {
                        await Navigator.of(context).push(
                          MaterialPageRoute<void>(
                            builder: (_) => GlintScreen(level: level),
                          ),
                        );
                        if (mounted) setState(() {});
                      },
