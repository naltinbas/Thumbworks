...
import 'package:wirecombe/ui/mark.dart';
import 'package:wirecombe/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the star wired', () {
    // The picture is a real run, one hub holding every line,
    // found by the sweep and checked here.
    final play = Mark.star;
    expect(play.isDone, isTrue);
    expect(play.lanesEnds, hasLength(4));
    expect(play.looped, isFalse);
  });
