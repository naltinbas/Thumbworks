...
import 'combe_screen.dart';
import 'mark.dart';
import 'palette.dart';

/// The fence, stile by combe.
          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Wire the cottages into one run: Cayley '
                  'counts the runs and two windows always burn.',
              ...
              Expanded(
                child: ListView.builder(
                  itemCount: Combes.count,
                  itemBuilder: (context, number) {
                    final combe = Combes.at(number);
                    final fewest = Best.fewest(combe.name);
                    return ListTile(
                      leading: Text(
                        '${number + 1}',
                      ...
                      onTap: () async {
                        await Navigator.of(context).push(
                          MaterialPageRoute<void>(
                            builder: (_) => CombeScreen(combe: combe),
                          ),
                        );
                        if (mounted) setState(() {});
                      },
