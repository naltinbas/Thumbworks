...
import 'package:kithwell/ui/mark.dart';
import 'package:kithwell/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the star, real and checked', () {
    // The picture is Ann friends with all five and nobody else with
    // anybody: people average 1 2/3, the friends named 3, the widest gap.
    final play = Mark.star;
    expect(Rules.tell(play.plan), 'Ann-Bess, Ann-Cal, Ann-Dot, Ann-Ed, Ann-Fay');
    expect(play.degrees, [5, 1, 1, 1, 1, 1]);
    expect(play.average, Frac.of(5, 3));
    expect(play.friendsAverage, Frac.of(3));
    expect(play.friendsAverageBySquares, Frac.of(3));
    expect(play.gap, Frac.of(4, 3));
