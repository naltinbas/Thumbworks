...
import 'package:trickmere/ui/mark.dart';
import 'package:trickmere/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the pair of hearts laid, real and checked', () {
    // The picture is the 7 of hearts hidden and 2H KC 5D 9S laid, the
    // partner naming the seven.
    final play = Mark.hearts;
    expect(play.isDone, isTrue);
    expect(play.named, 32);
  });
