          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Condorcet\'s paradox at the village show: three judges rank '
                  'the pies, and the majority can run in a ring; with three '
                  'pies, a pie that beats both others is always somebody\'s '
                  'first choice.',
