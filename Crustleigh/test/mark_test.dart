...
import 'package:crustleigh/ui/mark.dart';
import 'package:crustleigh/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the ring of three, real and checked', () {
    // The picture is the sweep's first ring: the three turnings of
    // apple bramble cherry, each pie beating the next two to one.
    final play = Mark.ring;
    expect(play.profile, [[0, 1, 2], [1, 2, 0], [2, 0, 1]]);
    expect(play.ringOrder, [0, 1, 2]);
    expect(play.winner, isNull);
