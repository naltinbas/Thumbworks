...
import 'package:leechmere/ui/mark.dart';
import 'package:leechmere/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the wide reversal, real and checked', () {
    // The picture is Ash at ten and twenty, Birch at fifty and ten: Ash
    // ahead in both seasons and twenty in a hundred behind over the year.
    final play = Mark.wide;
    expect(play.loads, [10, 20, 50, 10]);
    expect(play.ashYear, (15, 30));
    expect(play.birchYear, (42, 60));
