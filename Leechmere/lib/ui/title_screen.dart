          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Simpson\'s paradox at the physic garden: one healer cures a '
                  'bigger share than the other in both seasons and a smaller '
                  'share over the year, if the loads are uneven; with equal '
                  'loads it never happens.',
