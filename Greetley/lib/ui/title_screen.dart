...
import 'lawn_screen.dart';
import 'mark.dart';
import 'palette.dart';

/// The fence, stile by fete.
          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Shake hands on the lawn: the odd-handed '
              ...
              Expanded(
                child: ListView.builder(
                  itemCount: Lawns.count,
                  itemBuilder: (context, number) {
                    final fete = Lawns.at(number);
                    final fewest = Best.fewest(fete.name);
                    return ListTile(
                      leading: Text(
                        '${number + 1}',
                      ...
                      onTap: () async {
                        await Navigator.of(context).push(
                          MaterialPageRoute<void>(
                            builder: (_) => LawnScreen(fete: fete),
                          ),
                        );
                        if (mounted) setState(() {});
                      },
