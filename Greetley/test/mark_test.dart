...
import 'package:greetley/ui/mark.dart';
import 'package:greetley/ui/palette.dart';
...
void main() {
  ...
  test('the mark is a four-odd lawn', () {
    // The picture is a real lawn with four hands up, found by
    // the sweep and checked here.
    final play = Mark.fourOdd;
    expect(play.isDone, isTrue);
    expect(play.oddHanded, hasLength(4));
  });
