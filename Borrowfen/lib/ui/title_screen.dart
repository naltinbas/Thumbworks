          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Lend and borrow over the roads until no house '
                  'owes. Whether it can be done was decided first.',
              ...
              Expanded(
                child: ListView.builder(
                  itemCount: Villages.count,
                  itemBuilder: (context, number) {
                    final village = Villages.at(number);
                    final fewest = Best.fewest(village.name);
                    return ListTile(
                      leading: Text(
                        '${number + 1}',
                      ...
                      onTap: () async {
                        await Navigator.of(context).push(
                          MaterialPageRoute<void>(
                            builder: (_) => FenScreen(village: village),
                          ),
                        );
                        if (mounted) setState(() {});
                      },
