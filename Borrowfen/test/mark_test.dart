...
import 'package:borrowfen/ui/mark.dart';
import 'package:borrowfen/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the charity as it opens', () {
    // The picture is a real village, debts and coin where the
    // level starts a finger off.
    final play = Mark.charity;
    expect(play.village.name, 'The Charity');
    expect(play.isDone, isFalse);
    expect(play.rules.winnable(play.pounds), isTrue);
  });
