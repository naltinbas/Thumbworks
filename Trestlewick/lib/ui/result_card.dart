...
/// The card under a frame that is standing.
class ResultCard extends StatelessWidget {
  ...
  String get _line {
    final days = play.day == 1 ? 'one day' : '${play.day} days';
    if (play.isFewest) {
      return 'The whole frame standing in $days, and there is no way to do it '
          'in fewer.';
    }
    return 'The whole frame standing in $days. It can be done in '
        '${play.answer.days}.';
  }
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Expanded(child: _Button(label: 'Frames', onTap: onLeave)),
                  const SizedBox(width: 9),
                  Expanded(
