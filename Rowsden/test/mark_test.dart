...
import 'package:rowsden/ui/mark.dart';
import 'package:rowsden/ui/palette.dart';
...
void main() {
  ...
  test('the mark is Kirkman\'s week walked whole, real and checked', () {
    // The picture is rows given and columns and the two slants placed:
    // every pair met once.
    final play = Mark.week;
    expect(play.isDone, isTrue);
    expect(play.pairsMet, hasLength(36));
  });
