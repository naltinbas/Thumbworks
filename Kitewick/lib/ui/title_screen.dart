          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Slates on a kite-shaped roof, the Aztec diamond: the '
                  'order-n kite has exactly two to the n(n+1)/2 slatings, '
                  'and every slating lays an even count of slates across.',
