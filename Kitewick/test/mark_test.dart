...
import 'package:kitewick/ui/mark.dart';
import 'package:kitewick/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the order three slated, real and checked', () {
    // The picture is the sweep's thirty-second slating of the order
    // three's sixty-four: whole, an even count across, and The
    // Sixty-Four is landed by it.
    final play = Mark.slated;
    expect(play.level.order, 3);
    expect(play.isFull, isTrue);
    expect(play.level.kite.covers(play.laid), isTrue);
