...
import 'mark.dart';
import 'palette.dart';
import 'whistle_screen.dart';

/// The sham, call by call.
          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'A shepherd\'s calls to the dog, whistled in high and low '
                  'notes, and no call may begin with another whole one: it can '
                  'be done exactly when the calls\' shares of the tunes come '
