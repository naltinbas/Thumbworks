...
import 'package:brickholme/ui/mark.dart';
import 'package:brickholme/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the eight yard paved, real and checked', () {
    // The picture is the walk's paving of the eight yard: twenty-one
    // bricks round the drain two flags in from the corner.
    final play = Mark.eightYard;
    expect(play.isDone, isTrue);
    expect(play.bricks, hasLength(21));
  });
