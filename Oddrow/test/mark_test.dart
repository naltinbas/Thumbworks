...
import 'package:oddrow/ui/mark.dart';
import 'package:oddrow/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the full row, real and checked', () {
    // The picture is the wall wound to fifteen, sixteen odds
    // lit under the whole lace.
    final play = Mark.fullRow;
