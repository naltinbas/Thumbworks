...
import 'package:stitchfen/ui/mark.dart';
import 'package:stitchfen/ui/palette.dart';
...
void main() {
  ...
  test('the mark is one of the six eights', () {
    // The picture is a real ladder-free eight, found by the
    // sweep and checked here.
    final play = Mark.eight;
    expect(play.isDone, isTrue);
    expect(play.ladders, isEmpty);
    expect(play.threads, hasLength(8));
  });
