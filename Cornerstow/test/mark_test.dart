...
import 'package:cornerstow/ui/mark.dart';
import 'package:cornerstow/ui/palette.dart';
...
void main() {
  ...
  test('the mark is Nicomachus\'s paving of the six, real and checked', () {
    // The picture is the gnomons of three: the one in the corner, the
    // two and its halves round it, the three threes round that.
    final play = Mark.six;
    expect(play.isDone, isTrue);
    expect(play.bareCells, 0);
    expect(play.laid.length, 7);
  });
