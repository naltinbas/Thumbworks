          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Nicomachus\'s theorem as a paved yard: one flag of one, two '
                  'of two, three of three fill a square whose side is one plus '
                  'two plus three, the cubes summed being the square of the sum, '
                  'and the last even flag must be cut in two.',
