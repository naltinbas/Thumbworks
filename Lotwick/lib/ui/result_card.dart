  ...
  Widget build(BuildContext context) {
    ...
    if (done) {
      ...
      words = 'In the sealed ring your bid never sets the price. It settles '
          ...
          'ones already bid at or past their worth, bought at a loss; pull it '
          'under and the only beasts it drops are the ones you would have '
          'taken under their worth, a gain thrown away. In between nothing '
          'changes. Here the bid of ${play.bid} earns '
