...
import 'package:knuckleby/ui/mark.dart';
import 'package:knuckleby/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the other bones, cut true', () {
    // The mark goes through the same code a finger goes through, so
    // the picture is a trade a test makes itself.
    final play = Mark.opening;
    expect(play.bench.name, 'The Other Bones');
    expect(play.isDone, isTrue);
    expect(play.one, [1, 2, 2, 3, 3, 4]);
    expect(play.two, [1, 3, 4, 5, 6, 8]);
  });
