...
import 'package:addlemoor/ui/mark.dart';
import 'package:addlemoor/ui/palette.dart';
...
void main() {
  ...
  test('the mark is one of the eighteen thirteens', () {
    // The picture is a real clean thirteen, found by the sweep
    // and checked here.
    final play = Mark.thirteen;
    expect(play.badSums, isEmpty);
    expect(play.painting, hasLength(13));
  });
