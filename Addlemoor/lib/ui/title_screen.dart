          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Paint the stones so no stone is the sum of '
                  'two sharing its paint.',
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, number) {
                    ...
                    final fewest = Best.fewest(moor.name);
                    return ListTile(
                      leading: Text(
                        '${number + 1}',
                      ...
                      onTap: () async {
                        await Navigator.of(context).push(
                          MaterialPageRoute<void>(
                            builder: (_) => MoorScreen(moor: moor),
                          ),
                        );
                        if (mounted) setState(() {});
                      },
