          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Fill the rota: every hand at every station once, '
                  'every hand every day once, round the fixed shifts.',
              ...
              Expanded(
                child: ListView.builder(
                  itemCount: Rotas.count,
                  itemBuilder: (context, number) {
                    final rota = Rotas.at(number);
                    final fewest = Best.fewest(rota.name);
                    return ListTile(
                      leading: Text(
                        '${number + 1}',
                      ...
                      subtitle: Text(
                        '${rota.task[0].toUpperCase()}${rota.task.substring(1)}'
