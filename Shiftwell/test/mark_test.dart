...
import 'package:shiftwell/ui/mark.dart';
import 'package:shiftwell/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the four fixed finished, real and checked', () {
    // The picture is the one finishing of the four fixed shifts.
    final play = Mark.fourFixed;
