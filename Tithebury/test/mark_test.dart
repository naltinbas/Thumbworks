...
import 'package:tithebury/ui/mark.dart';
import 'package:tithebury/ui/palette.dart';
...
void main() {
  ...
  test('the mark is twenty-eight, perfect, real and checked', () {
    // The picture is 28 over its divisors 1, 2, 4, 7 and 14 laid end to
    // end, coming out exactly even: The Perfect's own aim.
    final play = Mark.perfect;
    expect(play.number, 28);
    expect(play.divisors, [1, 2, 4, 7, 14]);
    expect(play.tithe, 28);
    expect(Rules.titheByFormula(28), 28);
