          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Ballots counted one at a time: the winner leads all the '
                  'way through in exactly the majority over the poll of the '
                  'orders, Bertrand\'s ballot theorem, and a level poll never '
                  'lets one side lead throughout.',
