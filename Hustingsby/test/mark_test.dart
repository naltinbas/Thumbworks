...
import 'package:hustingsby/ui/mark.dart';
import 'package:hustingsby/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the count that turns twice, real and checked', () {
    // The picture is The Two Turns' aim: five Ash and three Birch drawn
    // in the sweep's first order where the lead changes hands twice.
    final play = Mark.turns;
    expect(play.level.name, 'The Two Turns');
    expect(play.isComplete, isTrue);
    expect(Rules.changesOfHands(play.drawn), 2);
