...
import 'package:dealstone/ui/mark.dart';
import 'package:dealstone/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the stair of ten, real and checked', () {
    // The picture is four, three, two, one: the hand the deal
    // pays straight back.
    final play = Mark.stair;
    expect(play.deals, 0);
    expect(play.piles, [4, 3, 2, 1]);
  });
