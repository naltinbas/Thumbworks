...
import 'package:suppermere/ui/mark.dart';
import 'package:suppermere/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the cube seated, real and checked', () {
    // The picture is the walk's seating of the cube: eight guests, twelve
    // quarrels, every one parted between the tables.
    final play = Mark.cube;
