          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Guests who quarrel, and two tables to seat them at so no '
                  'quarrel shares a table: it can be done exactly when no '
                  'odd ring of quarrels runs through them.',
