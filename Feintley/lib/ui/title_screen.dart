          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Fermat\'s test: raise a base to one less than the number '
                  'and land on one. Every prime passes, and the composites '
                  'that pass are liars, every number to 1,200 tried.',
