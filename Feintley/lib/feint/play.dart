...
String whyWords(Play play) {
  ...
  return 'Fermat\'s test: a number n is asked to raise a base a to the power '
      ...
      'the multiples a, 2a and on to (p - 1)a leave the remainders 1 to p - 1 '
      'by p once each, so their product is (p - 1)! both times a to the p - 1 '
      'and plain, and the power is one. Composites mostly fail, and the test '
      'is how a computer first sorts primes from the rest; but some '
      'composites pass, liars for the base, 341 the first for base two, and '
      'a few pass on every base they share no factor with, Carmichael '
      'numbers, 561 the first.\n\n'
