...
import 'package:feintley/ui/mark.dart';
import 'package:feintley/ui/palette.dart';
...
void main() {
  ...
  test('the mark is 341 on base two, real and checked', () {
    // The picture is 341, which is 11 times 31, passing Fermat's test on
    // base two: the first liar of that base.
    final play = Mark.liar;
    expect((play.number, play.base), (341, 2));
    expect(play.prime, isFalse);
    expect(play.factor, 11);
    expect(play.landing, 1);
    expect(play.passes, isTrue);
    expect(play.liar, isTrue);
