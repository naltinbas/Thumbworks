...
import 'package:sevenby/ui/mark.dart';
import 'package:sevenby/ui/palette.dart';
...
void main() {
  ...
  test('the mark is a seventh, real and checked', () {
    // The picture is 0.142857 under its bar and the six remainders round
    // the seven-hour ring: The Six's aim.
    final play = Mark.seventh;
    expect((play.prime, play.top), (7, 1));
    expect(play.digits, [1, 4, 2, 8, 5, 7]);
    expect(play.remainders, [1, 3, 2, 6, 4, 5]);
    expect(play.period, 6);
