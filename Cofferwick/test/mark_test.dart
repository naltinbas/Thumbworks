...
import 'package:cofferwick/ui/mark.dart';
import 'package:cofferwick/ui/palette.dart';
...
void main() {
  ...
  test('the mark is Bertrand\'s three coffers, real and checked', () {
    // The picture is gold and gold, gold and silver, silver and silver:
    // the laying of the puzzle, chance 2/3.
    final play = Mark.bertrand;
    expect(play.coins, [true, true, true, false, false, false]);
    expect(play.sorts, (1, 1, 1));
    expect(play.chance, Frac.of(2, 3));
    expect(Rules.chanceByBayes(play.coins), Frac.of(2, 3));
