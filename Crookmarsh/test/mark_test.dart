...
import 'package:crookmarsh/ui/mark.dart';
import 'package:crookmarsh/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the one frame standing', () {
    // The picture is a real needle setting, five posts holding
    // exactly one frame, found by the sweep and checked here.
    final play = Mark.oneFrame;
