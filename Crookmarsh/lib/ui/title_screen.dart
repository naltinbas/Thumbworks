...
import 'marsh_screen.dart';
import 'mark.dart';
import 'palette.dart';

/// The fence, stile by marsh.
          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Stand posts, none three to a line, and count '
                  'the frames: five posts never go without.',
              ...
              Expanded(
                child: ListView.builder(
                  itemCount: Marshes.count,
                  itemBuilder: (context, number) {
                    final marsh = Marshes.at(number);
                    final fewest = Best.fewest(marsh.name);
                    return ListTile(
                      leading: Text(
                        '${number + 1}',
                      ...
                      onTap: () async {
                        await Navigator.of(context).push(
                          MaterialPageRoute<void>(
                            builder: (_) => MarshScreen(marsh: marsh),
                          ),
                        );
                        if (mounted) setState(() {});
                      },
