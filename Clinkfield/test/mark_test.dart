...
import 'package:clinkfield/ui/mark.dart';
import 'package:clinkfield/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the four counts, real and checked', () {
    // The picture is the ceiling itself: counts four, three,
    // two, two, one, alike badges wearing alike tints.
    final play = Mark.fourCounts;
