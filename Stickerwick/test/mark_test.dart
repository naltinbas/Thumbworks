...
import 'package:stickerwick/ui/mark.dart';
import 'package:stickerwick/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the album of six at thirteen packets, real and checked', () {
    // The picture is the page of six stickers; the setting it stands at
    // is six and thirteen, the coin-toss point, The Half Dozen's own aim.
    final play = Mark.six;
    expect((play.stickers, play.packets), (6, 13));
