          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Stickers for an album, one to a packet at random: a set '
                  'of n takes n times the nth harmonic number of packets on '
                  'average, and no count of packets ever makes the set '
                  'certain.',
