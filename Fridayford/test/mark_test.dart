...
import 'package:fridayford/ui/mark.dart';
import 'package:fridayford/ui/palette.dart';
...
void main() {
  ...
  test('the mark is a Thursday year with three Fridays, real and checked', () {
    // The picture is a common year beginning on a Thursday, its Fridays
    // the thirteenth in February, March and November ringed.
    final play = Mark.thursday;
    expect(play.isDone, isTrue);
    expect(play.fridays, [1, 2, 10]);
  });
