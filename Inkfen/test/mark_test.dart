...
import 'package:inkfen/ui/mark.dart';
import 'package:inkfen/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the full four, real and checked', () {
    // The picture is the six strings split into the three
    // matchings, one ink each, not a clash anywhere.
    final play = Mark.fullFour;
