...
import 'package:wardsby/ui/mark.dart';
import 'package:wardsby/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the packed ten drawn to win, real and checked', () {
    // The picture is the walk's first drawing giving ten Blues in two
    // columns three wards of the five.
    final play = Mark.packed;
    expect(play.sound, isTrue);
    expect(play.blueWins, 3);
