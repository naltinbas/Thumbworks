...
import 'package:combwell/ui/mark.dart';
import 'package:combwell/ui/palette.dart';
...
void main() {
  ...
  test('the mark is Adams\' comb, real and checked', () {
    // The picture is the magic hexagon filled: every line thirty-eight.
    final play = Mark.adams;
    expect(play.isDone, isTrue);
    expect(play.rightLines, hasLength(15));
  });
