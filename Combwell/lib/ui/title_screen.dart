...
import 'mark.dart';
import 'palette.dart';
import 'comb_screen.dart';

/// The sham, comb by comb.
          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'The magic hexagon: nineteen cells in a comb, the numbers '
                  'one to nineteen, and every line to sum to thirty-eight, '
                  'the only sum that can be; one comb does it, twelve ways '
                  'round.',
