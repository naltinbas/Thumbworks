...
import 'package:studwell/ui/mark.dart';
import 'package:studwell/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the four-court paved, real and checked', () {
    // The picture is Golomb's quartering round the corner well,
    // which is the one paving the sweep finds.
    final play = Mark.cornerWell;
    expect(play.isDone, isTrue);
    expect(play.laid, hasLength(5));
  });
