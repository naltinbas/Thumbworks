...
class ResultCard extends StatelessWidget {
  ...
  String get _line {
    ...
    return 'Paid to the penny$asked: ${play.cheaps} at '
        '${play.letter.cheap}d and ${play.dears} at '
        '${play.letter.dear}d.';
  }
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Expanded(child: _Button(label: 'Letters', onTap: onLeave)),
                  const SizedBox(width: 9),
                  Expanded(
        ...
        child: GestureDetector(
          ...
          child: ExcludeSemantics(
            child: Container(
              height: 44,
              decoration: BoxDecoration(
                color: lit ? Palette.edge : Palette.office,
