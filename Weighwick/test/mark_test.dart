...
import 'package:weighwick/ui/mark.dart';
import 'package:weighwick/ui/palette.dart';
...
void main() {
  ...
  test('the mark is twenty balanced, real and checked', () {
    // The picture is the load of twenty level: 27 and 3 across, 9 and 1
    // beside it, all four weights on the scale.
    final play = Mark.twenty;
    expect(play.isDone, isTrue);
    expect(play.across, 30);
    expect(play.beside, 10);
  });
