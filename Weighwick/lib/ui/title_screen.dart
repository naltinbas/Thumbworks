          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Four weights, 1, 3, 9 and 27, on either pan of the '
                  'scale: every load to forty balances exactly one way, and '
                  'the why is counting in threes.',
