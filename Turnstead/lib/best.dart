...
/// The fewest askings each card has been written with.
///
/// Keyed on the name rather than the place in the list, so putting a new
/// one in the middle does not hand somebody else's record to a green
/// nobody has played. Stranded cards write nothing.
class Best {
  Best(this._prefs);

  final SharedPreferences _prefs;

  static const _prefix = 'fixtured.';
  ...
  /// Writes a written card down, and says whether it beat what was
  /// there.
