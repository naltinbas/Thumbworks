          ...
          child: Column(
            ...
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Write the fixture card: every side plays every side '
                  'exactly once.',
                  textAlign: TextAlign.center,
                  style: TextStyle(
...
class _GreenRow extends StatelessWidget {
  ...
  /// The fewest askings this card has been written with, or null.
  final int? askings;
  ...
  Widget build(BuildContext context) {
    ...
    return Semantics(
      button: true,
      label: '${green.name}, ${green.sides} sides',
          ...
          child: Container(
            ...
            child: Row(
              children: [
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        green.possible
                            ? '${green.sides} sides, ${green.rounds} '
                                'rounds, ${green.pairs} matches'
                            : '${green.sides} sides in ${green.rounds} '
                                'rounds: no card fits, one breath says '
                                'why',
                        style: TextStyle(
                          color: green.possible
                              ? Palette.inkDim
                              : Palette.badges[0],
                          fontSize: 12,
                        ),
                ...
                if (done != null)
                  Text(
                    done == 0 ? 'written unasked' : 'written, asked $done',
                    style: const TextStyle(
                      color: Palette.good,
                      fontSize: 12,
                      fontWeight: FontWeight.w600,
