...
import 'package:marrowden/ui/mark.dart';
import 'package:marrowden/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the four-marrow bench, a best-yet up', () {
    // The mark goes through the same code a button goes through, so
    // the picture is a sitting a test judges to its end.
    final play = Mark.opening;
    expect(play.show.name, 'The Four Marrows');
    expect(play.shown, 2);
