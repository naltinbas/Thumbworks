...
import 'package:tetherdown/ui/mark.dart';
import 'package:tetherdown/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the nine tethered', () {
    // The picture is a real fullest tethering on six posts,
    // found by the sweep and checked here.
    final play = Mark.nine;
    expect(play.isDone, isTrue);
    expect(play.knotted, isEmpty);
    expect(play.rules.twoPasture(play.ropes), isTrue);
  });
