...
import 'package:linesby/ui/mark.dart';
import 'package:linesby/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the level line, real and checked', () {
    // The picture is the triangle (0, 0), (4, 0), (1, 3) with its three
    // centres at one height, The Level Line's own aim.
    final play = Mark.line;
    expect(play.pegs, [(0, 0), (4, 0), (1, 3)]);
    expect(Rules.told(play.centroid), '(5/3, 1)');
    expect(Rules.told(play.circumcentre), '(2, 1)');
    expect(Rules.told(play.orthocentre), '(1, 1)');
