...
import 'package:bubbleford/ui/mark.dart';
import 'package:bubbleford/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the gasket, real and checked', () {
    // The picture is bends 2, 2 and 3: the bubble of bend 15 in the gap
    // and the unit bubble round the outside.
    final play = Mark.gasket;
    expect(play.bends, [2, 2, 3]);
    expect(play.fourths, (15, -1));
    expect(play.fourthsByTrial, [-1, 15]);
