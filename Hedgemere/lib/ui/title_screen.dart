          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Strip every post with one path left, then do it again: '
                  'whatever hedge you build, one post is left standing at the '
                  'end, or two, and never three.',
                      ...
                      onTap: () async {
                        await Navigator.of(context).push(
                          MaterialPageRoute<void>(
                            builder: (_) => HedgeScreen(level: level),
                          ),
                        );
                        if (mounted) setState(() {});
                      },
