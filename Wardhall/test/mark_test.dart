...
import 'package:wardhall/ui/mark.dart';
import 'package:wardhall/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the ell, lit from its bend', () {
    // The mark goes through the same code a finger goes through, so
    // the picture is a floor a test lights itself.
    final play = Mark.opening;
    expect(play.hall.name, 'The Ell');
    expect(play.isDone, isTrue);
    expect(play.wards, hasLength(1));
  });
