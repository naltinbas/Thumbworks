...
import 'package:onesby/ui/mark.dart';
import 'package:onesby/ui/palette.dart';
...
void main() {
  ...
  test('the mark is seven ones, real and checked', () {
    // The picture is the row of seven ones, 127, prime both ways, the
    // row that makes 8,128: The Perfect Eight Thousand's aim.
    final play = Mark.seven;
    expect(play.exponent, 7);
    expect(play.row, BigInt.from(127));
    expect(play.rowIsPrime, isTrue);
    expect(play.rowIsPrimeByLucasLehmer, isTrue);
