          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Rows of ones in binary, Mersenne\'s numbers: prime only '
                  'when the row is prime long, and not always then, told '
                  'twice, by dividing and by the Lucas-Lehmer chain.',
