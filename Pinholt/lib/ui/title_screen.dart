          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Set pins on the board and count the frames: four '
                  'pins at the corners of a plot, none tucked inside.',
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, number) {
                    ...
                    final fewest = Best.fewest(plot.name);
                    return ListTile(
                      leading: Text(
                        '${number + 1}',
                      ...
                      subtitle: Text(
                        '${plot.task[0].toUpperCase()}${plot.task.substring(1)}'
