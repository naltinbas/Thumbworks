...
import 'package:pinholt/ui/mark.dart';
import 'package:pinholt/ui/palette.dart';
...
void main() {
  ...
  test('the mark is a fence of three with its lone frame, real and checked', () {
    // The picture is five pins, no three in a line, a fence of three,
    // and the one frame the theorem builds from the two inside.
    expect(Mark.marksHold, isTrue);
    expect(Mark.loneFrame.frames, hasLength(1));
  });
