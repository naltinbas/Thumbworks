...
import 'package:crossleigh/ui/mark.dart';
import 'package:crossleigh/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the middle cut, real and checked', () {
    // The picture is the line through (6, 0) and (0, 4) across the
    // triangle: AB cut at its middle, CA at (0, 4), and BC far outside.
    final play = Mark.middle;
    expect(play.chosen, [(6, 0), (0, 4)]);
    expect(play.crosses, isTrue);
    expect(play.ratios, (Frac.one, Frac.of(-1, 2), Frac.of(2)));
    expect(Rules.product(play.ratios!), Frac.of(-1));
    expect(play.sidesInside, 2);
