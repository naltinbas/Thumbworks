          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'A line across a triangle on pegs, and the three ratios it '
                  'cuts the sides in: they multiply to one, an odd number of '
                  'the cuts outside, and never all three inside.',
