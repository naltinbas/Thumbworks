...
import 'package:sharewick/ui/mark.dart';
import 'package:sharewick/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the even hand, real and checked', () {
    // The picture is ABC, ABD, ACE, ADF, AEF, BCF, BDE, BEF, CDE, CDF:
    // every two sharing a friend, every friend in five.
    final play = Mark.even;
    expect(Rules.tell(play.family), 'ABC, ABD, ACE, ADF, AEF, BCF, BDE, BEF, CDE, CDF');
    expect(play.sharing, isTrue);
    expect(play.oneOfEachPair, isTrue);
    expect(play.hands, [5, 5, 5, 5, 5, 5]);
