...
import 'package:ledgeworth/ui/mark.dart';
import 'package:ledgeworth/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the harmonic four, real and checked', () {
    // The picture is four books over the desk edge, half, a quarter, a
    // sixth and an eighth, a whole book out and a twenty-fourth past.
    final play = Mark.four;
    expect(play.isDone, isTrue);
    expect(play.overhang, 25);
  });
