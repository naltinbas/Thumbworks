          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Tap three pegs and the plot they make is laid. The field '
                  'cuts into two equal plots and into six, but never into '
                  'three equal ones, nor any odd number.',
                      ...
                      onTap: () async {
                        await Navigator.of(context).push(
                          MaterialPageRoute<void>(
                            builder: (_) => PlotScreen(level: level),
                          ),
                        );
                        if (mounted) setState(() {});
                      },
