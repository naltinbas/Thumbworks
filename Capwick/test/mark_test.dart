...
import 'package:capwick/ui/mark.dart';
import 'package:capwick/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the five called down by the plan, real and checked', () {
    // The picture is the dealt five with the plan's calls made, four
    // right and the first man alone wrong.
