...
import 'package:withyshaw/ui/mark.dart';
import 'package:withyshaw/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the last quarter, worth what it claims', () {
    // The stalks come through the same painter the why uses, and the
    // sum is the quarter margin the game turns on.
    final play = Mark.standing;
    expect(play.worth.said, '1/4');
