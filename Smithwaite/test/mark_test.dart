...
import 'package:smithwaite/ui/mark.dart';
import 'package:smithwaite/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the fair day five, six true moves in', () {
    // Every move follows the walk through the same code a finger goes
    // through, so the picture is a puzzle still on course for its fewest.
    final play = Mark.sixIn;
    expect(play.made, 6);
    expect(play.couldStillBe, play.puzzle.fewest);
