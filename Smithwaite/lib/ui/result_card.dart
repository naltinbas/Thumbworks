...
class ResultCard extends StatelessWidget {
  ...
  String get _line {
    if (play.isFewest) {
      return 'The bar slides free on ${play.made} moves, and fewer cannot '
          'do it.';
    }
    return 'The bar slides free on ${play.made} moves. It can be done on '
        '${play.puzzle.fewest}.';
  }
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Expanded(child: _Button(label: 'Bench', onTap: onLeave)),
                  const SizedBox(width: 9),
                  Expanded(
        ...
        child: GestureDetector(
          ...
          child: ExcludeSemantics(
            child: Container(
              height: 44,
              decoration: BoxDecoration(
                color: lit ? Palette.edge : Palette.soot,
