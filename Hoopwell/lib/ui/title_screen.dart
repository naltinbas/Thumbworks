          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Lay stones in two rings on a hoop of seven holes. A lamp '
                  'lights where a dark hole plus a pale hole lands, and the '
                  'lamps can never fall below the floor.',
                      ...
                      onTap: () async {
                        await Navigator.of(context).push(
                          MaterialPageRoute<void>(
                            builder: (_) => HoopScreen(level: level),
                          ),
                        );
                        if (mounted) setState(() {});
                      },
