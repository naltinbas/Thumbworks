...
import 'package:steedwick/ui/mark.dart';
import 'package:steedwick/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the colour swap done, real and checked', () {
    // The picture is Guarini's swap finished, each steed across from
    // its own corner, and it keeps home's order round the ring.
    final play = Mark.swapped;
    expect(play.isDone, isTrue);
    expect(play.orderRound, [0, 2, 3, 1]);
  });
