...
import 'package:candleford/ui/mark.dart';
import 'package:candleford/ui/palette.dart';
...
void main() {
  ...
  test('the mark is twenty-three candles, real and checked', () {
    // The picture is the party of twenty-three, where a shared birthday
    // first turns more likely than not.
    final play = Mark.twentyThree;
    expect(play.guests, 23);
    expect(play.inHundred, '50.72');
