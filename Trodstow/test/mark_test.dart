...
import 'package:trodstow/ui/mark.dart';
import 'package:trodstow/ui/palette.dart';
...
void main() {
  ...
  test('the mark is a parish really joined up, on the cheapest', () {
    // Cut through the same code a finger goes through, so the picture is a
    // parish the game would call joined up on as few yards as there are.
    final play = Mark.joined;
    expect(play.isDone, isTrue);
    expect(play.isCheapest, isTrue);
    expect(play.cut, hasLength(Mark.parish.count - 1));
  });
