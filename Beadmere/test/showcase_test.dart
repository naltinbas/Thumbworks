...
///
/// On the board shots every bead was turned by a tap on that bead, so
/// no strip pictured is one the game could not string. The sham shots
...
void main() {
  ...
  for (final phone in phones.entries) {
    ...
    testWidgets('the five and the eight on ${phone.key}', (tester) async {
  ...
  testWidgets('the three and the five', (tester) async {
  ...
  testWidgets('the four and the six', (tester) async {
  ...
  testWidgets('one too long, admitted', (tester) async {
    ...
    await shoot(tester, 'toolong');
  });

  testWidgets('a strip part strung, on the small phone', (tester) async {
  ...
  testWidgets('show me naming the bead', (tester) async {
    await show(tester, phones['iphone-14']!, which: 3);
    await turnAll(tester, [1]);
