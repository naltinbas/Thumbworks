...
import 'package:beadmere/ui/mark.dart';
import 'package:beadmere/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the eleven-bead strip that dodges the divisor', () {
    final play = Mark.fibonacci;
    expect(play.beads, [0, 1, 0, 0, 1, 0, 1, 0, 0, 1, 0]);
    expect(Rules.repeats(play.beads, 5), isTrue);
    expect(Rules.repeats(play.beads, 8), isTrue);
    expect(Rules.repeats(play.beads, 1), isFalse);
