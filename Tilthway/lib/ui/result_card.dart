...
/// The card under a tilth brought home.
class ResultCard extends StatelessWidget {
  ...
  String get _line {
    ...
    return 'Every seed home$asked. Of every board of '
        '${play.tilth.seeds} seeds there is, this was the only one that '
        'could do it.';
  }
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Expanded(child: _Button(label: 'Tilths', onTap: onLeave)),
                  const SizedBox(width: 9),
                  Expanded(
        ...
        child: GestureDetector(
          ...
          child: ExcludeSemantics(
            child: Container(
              height: 44,
              decoration: BoxDecoration(
                color: lit ? Palette.edge : Palette.field,
