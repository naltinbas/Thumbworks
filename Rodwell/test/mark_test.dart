...
import 'package:rodwell/ui/mark.dart';
import 'package:rodwell/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the rod of twelve cut into four threes', () {
    final play = Mark.threes;
    expect(play.hands, 12);
    expect(play.cuts, {2, 5, 8});
    expect(play.parts, [3, 3, 3, 3]);
    expect(play.product, BigInt.from(81));
    expect(play.product, play.best);
