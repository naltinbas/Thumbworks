...
import 'package:mintcombe/ui/mark.dart';
import 'package:mintcombe/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the tidy top, real and checked', () {
    // The picture is 89, 34, 13, 5 and 2, every other coin from the
    // top: 143, the dearest price the tidy purse pays.
    final play = Mark.top;
    expect(play.picked, [89, 34, 13, 5, 2]);
    expect(play.sum, 143);
    expect(play.tidy, isTrue);
