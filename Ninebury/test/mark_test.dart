...
import 'package:ninebury/ui/mark.dart';
import 'package:ninebury/ui/palette.dart';
...
void main() {
  ...
  test('the mark is 738 walked round the dial, real and checked', () {
    // The picture is 7, 3 and 8 stepped round the nine-hour face, home
    // at nine: three different digits, one of The Nine's 84.
    final play = Mark.nine;
    expect(play.number, 738);
    expect(play.chain, [738, 18, 9]);
    expect(play.root, 9);
