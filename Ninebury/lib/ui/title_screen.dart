          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Casting out nines: add the digits down to one and you '
                  'have the remainder by nine, so a slip in a sum shows, '
                  'and a square never roots five.',
