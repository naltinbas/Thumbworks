...
String whyWords(Play play) {
  ...
  return 'The stones of the ford are numbered from the near bank, and the '
      ...
      '1845, in the stronger form n < p < 2n - 2, after checking the numbers '
      'up to three million; Pafnuty Chebyshev proved it in 1850 and printed '
      'the proof in 1852; Srinivasa Ramanujan gave a simpler proof in 1919, '
      'and Paul Erdos a short elementary one in 1932, his first paper in a '
      'research journal.\n\n'
      ...
      'each less than twice the one before, and the crossing that always '
      'takes the farthest stone in reach is one such chain, '
      '${Rules.chain.join(', ')} here.\n\n'
      'The sham walks every stone of the ford for the fewest hops. Before it '
      'shipped, the checker sieved the ford twice, once by Eratosthenes and '
      'once by trial division, and asked every number up to 200,000 for a '
      'dry stone inside its rope.\n\n'
      'This is ask $number, ${level.name}. ${level.note}\n\n'
      'The counts on the card at the end are the sweep\'s: every stone of '
      'the ford, taken in turn.';
}
