...
import 'package:noughtsmill/ui/mark.dart';
import 'package:noughtsmill/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the hundred wound', () {
    // The picture is the mill at a hundred, its twenty-four
    // noughts checked like any other winding.
    final play = Mark.hundred;
    expect(play.wound, 100);
    expect(play.noughts, 24);
  });
