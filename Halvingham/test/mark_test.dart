...
import 'package:halvingham/ui/mark.dart';
import 'package:halvingham/ui/palette.dart';
...
void main() {
  ...
  test('the mark is thirteen by seven kept, real and checked', () {
    // The picture is the ledger of thirteen by seven with the odd rows
    // ticked, ninety-one at the foot.
    final play = Mark.thirteenBySeven;
