          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'The peasant\'s multiplication: halve one number and double '
                  'the other, row by row, and keep the doubles beside the odd '
                  'halves; they add to the product, since the odd rows spell '
                  'the number in twos.',
