...
import 'package:notchfield/ui/mark.dart';
import 'package:notchfield/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the six inches, perfectly cut', () {
    // The pictured notches go through the same code a finger goes
    // through, so the logo is a live game, not an arrangement.
    final play = Mark.cutTrue;
    expect(play.isDone, isTrue);
    expect(play.notched, [0, 1, 4, 6]);
    expect(play.rules.isPerfect(play.notched), isTrue);
  });
