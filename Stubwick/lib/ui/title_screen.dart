          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'A five-digit ticket with a check digit by Luhn\'s rule: '
                  'every slip of one digit is caught, and the swaps and twins '
                  'that are not are named, every ticket summed.',
