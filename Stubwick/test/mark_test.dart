...
import 'package:stubwick/ui/mark.dart';
import 'package:stubwick/ui/palette.dart';
...
void main() {
  ...
  test('the mark is 4 9 9 2 4, real and checked', () {
    // The picture is the ticket 4 9 9 2 4: adds 4, 9, 9, 4 and 4, thirty,
    // and passes.
    final play = Mark.ticket;
    expect(play.digits, [4, 9, 9, 2, 4]);
    expect(play.adds, [4, 9, 9, 4, 4]);
    expect(play.sum, 30);
