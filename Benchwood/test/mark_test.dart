...
import 'package:benchwood/ui/mark.dart';
import 'package:benchwood/ui/palette.dart';
...
void main() {
  ...
  test('the mark is Belady\'s card, two carries in', () {
    final play = Mark.partWay;
    expect(play.level.slots, 3);
    expect(Rules.tellCard(play.card), 'A B C D A B E A B C D E');
    expect(play.walks, greaterThan(3));
    expect(play.finished, isFalse);
    expect(play.bench, hasLength(3));
  });
