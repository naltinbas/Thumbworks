...
import 'package:flagstead/ui/mark.dart';
import 'package:flagstead/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the six by eight with every post five paces off', () {
    final play = Mark.within;
    expect((play.wide, play.tall, play.px, play.py), (6, 8, 3, 4));
    expect(play.squares, [25, 25, 25, 25]);
    expect(play.acrossOne, 50);
    expect(play.acrossTwo, 50);
    expect(play.inside, isTrue);
