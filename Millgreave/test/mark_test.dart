...
import 'package:millgreave/ui/mark.dart';
import 'package:millgreave/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the five mills, set by the built rows', () {
    // Every mill was raised through the same code a finger goes
    // through, and the moor is set.
    final play = Mark.set;
    expect(play.isSet, isTrue);
    expect(play.standing, 5);
  });
