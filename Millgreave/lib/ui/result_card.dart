...
class ResultCard extends StatelessWidget {
  ...
  String get _line {
    ...
    return 'Every mill keeps its wind$asked. This moor can be set '
        '${play.moor.ways} way${play.moor.ways == 1 ? '' : 's'}, and '
        'this is one of them.';
  }
        ...
        child: GestureDetector(
          ...
          child: ExcludeSemantics(
            child: Container(
              height: 44,
              decoration: BoxDecoration(
                color: lit ? Palette.edge : Palette.sky,
