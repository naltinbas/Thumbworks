...
/// The card under a stack that is home.
class ResultCard extends StatelessWidget {
  ...
  String get _line {
    if (play.isFewest) {
      return 'The stack is home in ${play.made} moves, and the doubling says '
          'no fewer could ever do it.';
    }
    return 'The stack is home in ${play.made} moves. It can be done in '
        '${play.yard.fewest}.';
  }
