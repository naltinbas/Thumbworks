...
import 'package:beaconholt/ui/mark.dart';
import 'package:beaconholt/ui/palette.dart';
...
void main() {
  ...
  test('the mark is a country really watched, on the fewest', () {
    // Lit through the same code a finger goes through, so the picture is a
    // country the game would call finished, on as few beacons as there are.
    final play = Mark.watched;
    expect(play.isDone, isTrue);
    expect(play.isFewest, isTrue);
    expect(play.beacons, hasLength(Mark.land.fewest));
  });
