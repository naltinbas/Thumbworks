...
import 'package:pegbourne/ui/mark.dart';
import 'package:pegbourne/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the first riddle, answered', () {
    // The pictured pegs go through the same code a finger goes
    // through, so the logo is a live game, not an arrangement.
    final play = Mark.answered;
