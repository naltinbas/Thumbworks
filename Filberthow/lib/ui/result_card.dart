...
/// The card under an emptied hoard.
class ResultCard extends StatelessWidget {
  ...
  String get _line {
    if (play.won) {
      ...
      return 'The last nut is yours$asked. The smallest cluster, every '
          'time: that is the whole of it.';
    }
    return 'The grey squirrel took the last nut. Somewhere back up the '
        'hoard, a take handed it a split it could work, and it never '
        'gave the split back.';
  }
  ...
  Widget build(BuildContext context) => Padding(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Semantics(
                label: play.won ? 'the hoard is yours' : 'the hoard is lost',
              ...
              Row(
                children: [
                  ...
                  Expanded(child: _Button(label: 'Hoards', onTap: onLeave)),
                  const SizedBox(width: 9),
                  Expanded(
        ...
        child: GestureDetector(
          ...
          child: ExcludeSemantics(
            child: Container(
              height: 44,
              decoration: BoxDecoration(
                color: lit ? Palette.edge : Palette.wood,
