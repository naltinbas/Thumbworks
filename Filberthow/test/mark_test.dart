...
import 'package:filberthow/ui/mark.dart';
import 'package:filberthow/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the twenty, ringed into its clusters', () {
    // The clusters come through the same painter the why uses, and they
    // sum to the hoard.
    final play = Mark.ringed;
    expect(play.clusters, [13, 5, 2]);
    expect(play.clusters.fold(0, (sum, part) => sum + part), play.nuts);
  });
