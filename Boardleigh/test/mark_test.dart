...
import 'package:boardleigh/ui/mark.dart';
import 'package:boardleigh/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the little landing, half laid', () {
    // The pictured planks go through the same code a finger goes
    // through, so the logo is a live game, not an arrangement.
    var play = Mark.halfLaid;
    expect(play.planks, hasLength(2));
