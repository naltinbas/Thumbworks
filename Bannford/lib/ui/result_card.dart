...
/// The card under a settled party.
class ResultCard extends StatelessWidget {
  ...
  String get _line {
    ...
    final settles = play.party.settles;
    return 'Everyone wed and nobody would leave$asked. The sweep '
        'counts ${settles == 1 ? 'this the only settled pairing' : 'it '
            'one of $settles that settle'}.';
  }
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Expanded(child: _Button(label: 'Parties', onTap: onLeave)),
                  const SizedBox(width: 9),
                  Expanded(
        ...
        child: GestureDetector(
          ...
          child: ExcludeSemantics(
            child: Container(
              height: 44,
              decoration: BoxDecoration(
                color: lit ? Palette.edge : Palette.hall,
