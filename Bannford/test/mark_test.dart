...
import 'package:bannford/ui/mark.dart';
import 'package:bannford/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the mild house, settled', () {
    // The pictured pairing goes through the same code a finger goes
    // through, so the logo is a live game, not an arrangement.
    final play = Mark.settled;
    expect(play.isSettled, isTrue);
    expect(play.eloping, isEmpty);
  });
