...
import 'package:haltwick/ui/mark.dart';
import 'package:haltwick/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the gaps 10, 10 and 40, real and checked', () {
    // The picture is the sawtooth of the gaps 10, 10 and 40, average
    // wait 14 1/2 minutes, the gold line across it.
    final play = Mark.bunched;
    expect(play.gaps, [10, 10, 40]);
    expect(play.wait, Frac.of(29, 2));
    expect(play.waitByMinutes, Frac.of(29, 2));
