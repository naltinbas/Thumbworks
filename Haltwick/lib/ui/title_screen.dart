          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Three buses an hour and the minutes you wait for the '
                  'next: bunch them and the average wait grows, and it is '
                  'never under the fair share, every timetable waited out.',
