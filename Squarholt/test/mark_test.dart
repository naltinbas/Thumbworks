...
import 'package:squarholt/ui/mark.dart';
import 'package:squarholt/ui/palette.dart';
...
void main() {
  ...
  test('the mark is three and four, real and checked', () {
    // The picture is the oldest right angle in the book: nine
    // and sixteen paying twenty-five exactly.
    final play = Mark.threeAndFour;
