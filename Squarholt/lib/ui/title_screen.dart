          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Pay the hoard with two square tiles: three '
                  'past a four-times never pays.',
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, number) {
                    ...
                    final fewest = Best.fewest(hoard.name);
                    return ListTile(
                      leading: Text(
                        '${number + 1}',
                      ...
                      onTap: () async {
                        await Navigator.of(context).push(
                          MaterialPageRoute<void>(
                            builder: (_) => HoardScreen(hoard: hoard),
                          ),
                        );
                        if (mounted) setState(() {});
                      },
