...
import 'package:wantley/ui/mark.dart';
import 'package:wantley/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the one way, real and checked', () {
    // The picture is the only treading that lands 4, 4, 3, 3,
    // 2, built by the biggest-wish-first deal.
    final play = Mark.oneWay;
