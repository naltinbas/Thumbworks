        ...
        body: SafeArea(
          child: Column(
            children: [
              ...
              const SizedBox(height: 170, child: Mark()),
              const Text(
                'Wantley',
                style: TextStyle(
                  color: Palette.ink,
              ...
              const Padding(
                ...
                child: Text(
                  'Tread paths till every farm gets its wish: '
                  'an even sum is not enough.',
              ...
              Expanded(
                child: ListView.builder(
                  itemCount: Wishes.count,
                  itemBuilder: (context, number) {
                    final wish = Wishes.at(number);
                    final fewest = Best.fewest(wish.name);
                    return ListTile(
                      leading: Text(
                        '${number + 1}',
                      ...
                      onTap: () async {
                        await Navigator.of(context).push(
                          MaterialPageRoute<void>(
                            builder: (_) => WishScreen(wish: wish),
                          ),
                        );
                        if (mounted) setState(() {});
                      },
