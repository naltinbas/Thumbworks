...
import 'package:milesworth/ui/mark.dart';
import 'package:milesworth/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the fifteen run as 4, 5, 6, real and checked', () {
    // The picture is the lane of fifteen with 4 to 6 marked, three
    // stones adding to fifteen, and their coins below.
    final play = Mark.fifteen;
