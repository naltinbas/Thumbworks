...
import 'package:bakerley/ui/mark.dart';
import 'package:bakerley/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the pinwheel, real and checked', () {
    // The picture is the search's first filling of the four-by-four by
    // four tees.
    final play = Mark.pinwheel;
    expect(play.isDone, isTrue);
    expect(play.laid.length, 4);
    expect(play.laid.every((p) => p.$1 == 2), isTrue);
  });
