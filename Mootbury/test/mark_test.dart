...
import 'package:mootbury/ui/mark.dart';
import 'package:mootbury/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the moot of ten, real and checked', () {
    // The picture is ten seats among six, six and two, 4, 4, 2, and
    // eleven giving 5, 5, 1: Cote loses a seat.
    final play = Mark.ten;
    expect(play.seats, 10);
    expect(play.hamilton, [4, 4, 2]);
    expect(play.hamiltonNext, [5, 5, 1]);
    expect(play.loser, 2);
