...
import 'package:oddsworth/ui/mark.dart';
import 'package:oddsworth/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the square of seven, real and checked', () {
    // The picture is 1 + 3 + 5 + 7 + 9 + 11 + 13 as seven bands of dots
    // making a seven-by-seven square: The Square of Seven's aim.
    final play = Mark.seven;
    expect((play.first, play.count), (1, 7));
    expect(play.sum, 49);
    expect((play.inner, play.outer), (0, 7));
