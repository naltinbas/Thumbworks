...
import 'package:lampwath/ui/mark.dart';
import 'package:lampwath/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the famous four one crossing in', () {
    // The crossing follows the settling through the same code a finger goes
    // through, so the picture is the quick pair over with the lantern and the
    // night still at seventeen.
    final play = Mark.oneCrossing;
    expect(play.done, hasLength(1));
