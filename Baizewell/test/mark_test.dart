...
import 'package:baizewell/ui/mark.dart';
import 'package:baizewell/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the five by seven, real and checked', () {
    // The picture is the ball rolled on the five by seven: ten bounces
    // in thirty-five steps to the far pocket.
    final play = Mark.fiveBySeven;
    expect((play.along, play.up), (5, 7));
    expect(play.bounces, 10);
    expect(play.steps, 35);
    expect(play.pocket, (5, 7));
