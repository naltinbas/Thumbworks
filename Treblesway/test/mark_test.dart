...
import 'package:treblesway/ui/mark.dart';
import 'package:treblesway/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the full peal three changes in', () {
    // Every pull follows the search through the same code a finger goes
    // through, so the picture is a peal that can still come round.
    final play = Mark.threeIn;
    expect(play.made, 3);
    expect(play.rung, hasLength(4));
