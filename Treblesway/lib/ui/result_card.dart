...
/// The card under a peal that has come round.
class ResultCard extends StatelessWidget {
  ...
  String get _line {
    final rows = play.peal.goalRows;
    if (hints == 0) {
      return 'Every one of the $rows rows sounded once and rounds struck '
          'home, with never an asking.';
    }
    return 'Every one of the $rows rows sounded once and rounds struck home, '
        'with $hints asking${hints == 1 ? '' : 's'} along the way.';
  }
