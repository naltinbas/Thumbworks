...
import 'package:tablesham/ui/mark.dart';
import 'package:tablesham/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the one seating of three, real and checked', () {
    // The picture is the sweep's landing for three couples:
    // every husband parted from his wife.
    final play = Mark.threeCouples;
