          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Seat the husbands between the wives: no '
                  'couple side by side.',
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, number) {
                    ...
                    final fewest = Best.fewest(party.name);
                    return ListTile(
                      leading: Text(
                        '${number + 1}',
                      ...
                      subtitle: Text(
                        '${party.task[0].toUpperCase()}${party.task.substring(1)}'
