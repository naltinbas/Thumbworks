...
import 'package:cogsley/ui/mark.dart';
import 'package:cogsley/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the ring of four, turning, real and checked', () {
    // The picture is the square of four gears of one round the crank,
    // two with it and two against.
    final play = Mark.ring;
    expect(play.gears.length, 4);
