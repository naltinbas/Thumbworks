...
import 'package:farrierstead/ui/board_screen.dart';
import 'package:farrierstead/ui/boardview.dart';
...
Future<void> open(
  ...
  await tester.pumpWidget(const FarriersteadApp());
...
Future<void> tapSquare(WidgetTester tester, int c) async {
...
Future<void> tapAll(WidgetTester tester, List<int> squares) async {
  for (final c in squares) {
    await tapSquare(tester, c);
  }
}

/// Sets every knight as the pointer says.
