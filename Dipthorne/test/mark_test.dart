...
import 'package:dipthorne/ui/mark.dart';
import 'package:dipthorne/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the thirteen five chants in, you in the safe seat', () {
    // Every chant runs through the same code a finger goes through, so
    // the picture is a dip being survived.
    final play = Mark.fiveIn;
    expect(play.out, hasLength(5));
    expect(play.chosen, play.safe);
