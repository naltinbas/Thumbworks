...
import 'package:feltmere/ui/mark.dart';
import 'package:feltmere/ui/palette.dart';
...
void main() {
  ...
  test('the mark is one of the four agreements that win six', () {
    final play = Mark.six;
    expect(play.wins, 6);
    expect(play.losses, ['BBB', 'WWW']);
    expect(play.words, 6);
    expect(play.wrongs, 6);
    expect(Rules.hasQuiet(play.agreement), isFalse);
