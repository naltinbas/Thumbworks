...
import 'package:trebleworth/ui/mark.dart';
import 'package:trebleworth/ui/palette.dart';
...
void main() {
  ...
  test('the mark is three heaps making five, real and checked', () {
    // The picture is 3 + 1 + 1: five from three heaps, which two heaps
    // never make.
    expect(Rules.heaps(5, 3), [
      [1, 1, 3]
    ]);
    expect(Rules.heaps(5, 2), isEmpty);
    expect(Mark.five.level.name, 'The Five');
  });
