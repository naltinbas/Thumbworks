          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Five bins of grain and one rule for sharing it out: '
                  'take from a bin two ahead of another. However you share, '
                  'the fullest bin never rises.',
                      ...
                      onTap: () async {
                        await Navigator.of(context).push(
                          MaterialPageRoute<void>(
                            builder: (_) => AlmsScreen(level: level),
                          ),
                        );
                        if (mounted) setState(() {});
                      },
