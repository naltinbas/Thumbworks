...
import 'package:goatsbridge/ui/mark.dart';
import 'package:goatsbridge/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the three doors, real and checked', () {
    // The picture is three doors, one opened, switching: two in three.
    final play = Mark.three;
    expect((play.doors, play.opened, play.switching), (3, 1, true));
    expect(play.chance, (2, 3));
