...
import 'package:trestlemere/ui/mark.dart';
import 'package:trestlemere/ui/palette.dart';
...
void main() {
  ...
  test('the mark is a real seating of one, two and three', () {
    // The only shape three tables of different sizes can take with six
    // guests, which is the second ask's whole point.
    final mark = Mark.supper;
    expect(mark.laid, 3);
    expect(mark.sizes, [1, 2, 3]);
    expect(Rules.allDifferent(mark.tables), isTrue);
    expect(mark.level.meets(mark.tables), isTrue);
  });
