...
import 'package:gapstile/ui/mark.dart';
import 'package:gapstile/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the landed needle', () {
    // The picture is a real play at four over eleven, checked the
    // same way a finger's dialing would be.
    final play = Mark.needle;
