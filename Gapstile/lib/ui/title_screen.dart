          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Peg a hoop at a stride\'s multiples. The gaps '
                  'only ever take three lengths.',
              ...
              Expanded(
                child: ListView.builder(
                  itemCount: Stiles.count,
                  itemBuilder: (context, number) {
                    final stile = Stiles.at(number);
                    final fewest = Best.fewest(stile.name);
                    return ListTile(
                      leading: Text(
                        '${number + 1}',
                      ...
                      onTap: () async {
                        await Navigator.of(context).push(
                          MaterialPageRoute<void>(
                            builder: (_) => GapScreen(stile: stile),
                          ),
                        );
                        if (mounted) setState(() {});
                      },
