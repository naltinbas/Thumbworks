          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Spin and tip the painted boxes until every '
                  'wall of the stack shows every paint once.',
              ...
              Expanded(
                child: ListView.builder(
                  itemCount: BoxSets.count,
                  itemBuilder: (context, number) {
                    final set = BoxSets.at(number);
                    final fewest = Best.fewest(set.name);
                    return ListTile(
                      leading: Text(
                        '${number + 1}',
