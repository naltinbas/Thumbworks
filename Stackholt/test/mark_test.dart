...
import 'package:stackholt/ui/mark.dart';
import 'package:stackholt/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the old four settled', () {
    // The picture is a real settling found by the sweep, checked
    // the same way a finger's turning would be.
