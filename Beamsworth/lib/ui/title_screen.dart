          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Choose weights so no two parcels balance: '
                  'the seventh always finds the level.',
              ...
              Expanded(
                child: ListView.builder(
                  itemCount: Worths.count,
                  itemBuilder: (context, number) {
                    final worth = Worths.at(number);
                    final fewest = Best.fewest(worth.name);
                    return ListTile(
                      leading: Text(
                        '${number + 1}',
                      ...
                      onTap: () async {
                        await Navigator.of(context).push(
                          MaterialPageRoute<void>(
                            builder: (_) => BeamScreen(worth: worth),
                          ),
                        );
                        if (mounted) setState(() {});
                      },
