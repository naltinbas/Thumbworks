...
import 'package:beamsworth/ui/mark.dart';
import 'package:beamsworth/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the one clean six', () {
    // The picture is the only clean choice of six the sweep
    // ever finds, the beam hanging empty.
    final play = Mark.six;
