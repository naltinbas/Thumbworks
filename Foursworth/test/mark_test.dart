...
import 'package:foursworth/ui/mark.dart';
import 'package:foursworth/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the classic road, real and checked', () {
    // The picture is nought, one, three, seven walking its
    // whole seven turns to the dark.
    final play = Mark.classic;
