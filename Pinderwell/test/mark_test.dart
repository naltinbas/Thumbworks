...
import 'package:pinderwell/ui/mark.dart';
import 'package:pinderwell/ui/palette.dart';
...
void main() {
  ...
  test('the mark is a winnable field at its par', () {
    // The board, the rungs and the ewe come through the same painter a
    // drive goes through, so the picture is a drive that can be won.
    final play = Mark.standing;
    expect(play.winnable, isTrue);
    expect(play.couldFinishIn, play.field.fewest);
  });
