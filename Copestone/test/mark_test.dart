...
import 'package:copestone/ui/mark.dart';
...
void main() {
  ...
  test('the mark is the eight courses, stood by the walk', () {
    // The mark goes through the same code a heap-tap goes through,
    // so the picture is a wall a test raises itself.
    final play = Mark.opening;
    expect(play.pitch.name, 'The Eight Courses');
    expect(play.isDone, isTrue);
    expect(play.courses, hasLength(8));
  });
