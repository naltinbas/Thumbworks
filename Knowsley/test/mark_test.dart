...
import 'package:knowsley/ui/mark.dart';
import 'package:knowsley/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the answer, real and checked', () {
    // The picture is 4 and 13, sum 17 and product 52: all four things
    // said hold, and for no other pair.
    final play = Mark.answer;
    expect((play.x, play.y, play.sum, play.product), (4, 13, 17, 52));
    expect(play.said, (true, true, true, true));
