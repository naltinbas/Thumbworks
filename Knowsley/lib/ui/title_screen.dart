          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Two numbers, S told their sum and P their product, and '
                  'four things said between them: one pair fits, and the '
                  'sieve of every pair says which.',
