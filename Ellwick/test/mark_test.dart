...
import 'package:ellwick/ui/mark.dart';
import 'package:ellwick/ui/palette.dart';
...
void main() {
  ...
  test('the mark stands at the top rung, real and checked', () {
    // The picture is the square, its diagonal and the ladder up it, and
    // the setting it stands at is 70 and 99, the top rung of the dials,
    // one over: 9,801 to 9,800.
    final play = Mark.top;
    expect((play.side, play.diagonal), (70, 99));
    expect(play.miss, 1);
    expect(play.onLadder, isTrue);
    expect(Rules.rungs.last, (70, 99));
