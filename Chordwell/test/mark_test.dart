...
import 'package:chordwell/ui/mark.dart';
import 'package:chordwell/ui/palette.dart';
...
void main() {
  ...
  test('the mark is four times four and two times eight, real and checked', () {
    // The picture is the chord (3, 4) to (3, -4) halved at (3, 0) by the
    // horizontal diameter, 16 both ways.
    final play = Mark.sixteen;
    expect(play.chosen, [1, 5, 3, 9]);
    expect(Rules.tellPoint(play.crossing!), '(3, 0)');
