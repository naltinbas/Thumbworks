          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Two chords crossing in a wheel: the pieces of the one '
                  'multiply to the same as the pieces of the other, always, '
                  'and both to the radius squared less the crossing\'s '
                  'distance from the middle squared.',
