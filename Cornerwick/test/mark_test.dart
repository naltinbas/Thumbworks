...
import 'package:cornerwick/ui/mark.dart';
import 'package:cornerwick/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the square of pegs, real and checked', () {
    // The picture is (1, 1), (3, 1), (3, 3), (1, 3) with its four squares
    // built outward: centres at (2, 0), (4, 2), (2, 4) and (0, 2), the
    // joins four long and crossing at (2, 2).
    final play = Mark.square;
    expect(play.pegs, [(1, 1), (3, 1), (3, 3), (1, 3)]);
    expect(play.centres, [(4, 0), (8, 4), (4, 8), (0, 4)]);
    expect(play.lengthsSquared, (Frac.of(16), Frac.of(16)));
    expect(play.atRightAngles, isTrue);
    expect(play.turnedIsTheOther, isTrue);
