          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Four pegs in order, a square built outward on every side, '
                  'and the centres of opposite squares joined: the two joins '
                  'are equal and at right angles, whatever the pegs.',
