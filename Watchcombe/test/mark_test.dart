...
import 'package:watchcombe/ui/mark.dart';
import 'package:watchcombe/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the six yard watched, real and checked', () {
    // The picture is four watchmen one in from each corner of the six
    // yard, every flag lit.
    final play = Mark.sixYard;
    expect(play.isDone, isTrue);
    expect(play.watchmen, [7, 10, 25, 28]);
  });
