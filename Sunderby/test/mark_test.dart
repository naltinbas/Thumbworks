...
import 'package:sunderby/ui/mark.dart';
import 'package:sunderby/ui/palette.dart';
...
void main() {
  ...
  test('the mark is 5 + 2 + 1, real and checked', () {
    // The picture is eight sundered into 5 + 2 + 1: three parts, all
    // different, the aim of The Different, and 5 + 1 + 1 + 1 folded.
    final play = Mark.dots;
    expect(play.parts, [5, 2, 1]);
    expect(play.isDone, isTrue);
    expect(Rules.fold([5, 1, 1, 1]), [5, 2, 1]);
    expect(Levels.at(0).aim, [5, 2, 1]);
  });
