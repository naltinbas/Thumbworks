...
import 'package:rootley/ui/app.dart';
import 'package:rootley/ui/mark.dart';
import 'package:rootley/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the base 3 on the seven-hour clock, real and checked', () {
    // The picture is the walk 1, 3, 2, 6, 4, 5 and home: a full base of
    // seven, The Seven's own aim.
    final play = Mark.seven;
    expect((play.clock, play.base), (7, 3));
    expect(play.walk, [1, 3, 2, 6, 4, 5]);
    expect(play.order, 6);
