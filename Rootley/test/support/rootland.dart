...
import 'package:rootley/ui/root_screen.dart';
...
Future<void> open(
  ...
  await tester.pumpWidget(const RootleyApp());
...
RootScreenState state(WidgetTester tester) =>
    tester.state<RootScreenState>(find.byType(RootScreen));
...
/// Follows the pointer until the walk lands, [most] steps at most.
Future<void> walkByPointer(WidgetTester tester, {int most = 30}) async {
