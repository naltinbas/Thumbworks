...
import 'package:farthingford/ui/mark.dart';
import 'package:farthingford/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the three fifths, one wade from landing', () {
    // The mark goes through the same code a button goes through, so
    // the picture is a wade a test finishes.
    final play = Mark.opening;
    expect(play.reach.name, 'The Three Fifths');
    expect(play.stone, (3, 5));
