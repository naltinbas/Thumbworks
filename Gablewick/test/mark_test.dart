...
import 'package:gablewick/ui/mark.dart';
import 'package:gablewick/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the 13-14-15 gable, real and checked', () {
    // The picture is the triangle with sides 13, 14 and 15, area 84,
    // the biggest whole area to fifteen: The Uneven's own aim.
    final play = Mark.gable;
    expect(Rules.sorted(play.a, play.b, play.c), (13, 14, 15));
    expect(play.wholeArea, 84);
    expect(Rules.sixteenAreaSquaredByHeight(13, 15, 14), 16 * 84 * 84);
