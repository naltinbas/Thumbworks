...
import 'package:thirdwell/ui/mark.dart';
import 'package:thirdwell/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the twentieth walked, real and checked', () {
    // The picture is the stack after middle, top, bottom, counter 17
    // twentieth from the top.
    final play = Mark.twentieth;
    expect(play.isDone, isTrue);
    expect(play.place, 19);
  });
