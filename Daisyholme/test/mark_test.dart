...
import 'package:daisyholme/ui/mark.dart';
import 'package:daisyholme/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the daisy of seven, real and checked', () {
    // The picture is three petals round a crowned heart, every
    // pair sharing exactly one friend.
    final play = Mark.daisy;
    expect(play.isDone, isTrue);
    expect(play.settled, play.rules.pairs.length);
  });
