...
import 'package:chainhurst/ui/mark.dart';
import 'package:chainhurst/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the fewest of five landed', () {
    // The picture is a real placing, four bare chains round one
    // laden, checked the same way a finger's setting would be.
    final play = Mark.fewest;
    expect(play.bare, 4);
    expect(play.laden, 1);
