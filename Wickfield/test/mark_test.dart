...
import 'package:wickfield/ui/mark.dart';
import 'package:wickfield/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the first lamp, one press from dark', () {
    // The pictured board goes through the same code a finger goes
    // through, so the logo is a live game, not an arrangement.
    final play = Mark.lit;
    expect(play.lamps, 5);
    expect(play.fewestFromHere, 1);
    expect(play.press(4).isDark, isTrue);
  });
