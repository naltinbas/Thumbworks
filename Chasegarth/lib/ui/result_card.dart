...
/// The card under a forme that reads right.
class ResultCard extends StatelessWidget {
  ...
  String get _line {
    final word = play.chase.reading;
    if (play.isFewest) {
      return 'The line reads $word, in ${play.made} slides, and there is no '
          'shorter way from where it started.';
    }
    return 'The line reads $word, in ${play.made} slides. It can be done in '
        '${play.forme.fewest}.';
  }
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Expanded(child: _Button(label: 'Formes', onTap: onLeave)),
                  const SizedBox(width: 9),
                  Expanded(
