...
import 'package:chasegarth/ui/mark.dart';
import 'package:chasegarth/ui/palette.dart';
...
void main() {
  ...
  test('the mark is a chase two slides from reading right', () {
    // Slid through the same code a finger goes through, along its own
    // shortest way, so the picture is a forme the game could really be four
    // slides into.
    final play = Mark.nearlyDone;
    expect(play.made, 4);
    expect(play.left, 2);
    expect(play.isLocked, isFalse);
