          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Fold the paddock into pens: fourteen ways, '
                  'and the ears never come off.',
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, number) {
                    ...
                    final fewest = Best.fewest(fold.name);
                    return ListTile(
                      leading: Text(
                        '${number + 1}',
                      ...
                      onTap: () async {
                        await Navigator.of(context).push(
                          MaterialPageRoute<void>(
                            builder: (_) => FoldScreen(fold: fold),
                          ),
                        );
                        if (mounted) setState(() {});
                      },
