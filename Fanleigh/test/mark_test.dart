...
import 'package:fanleigh/ui/mark.dart';
import 'package:fanleigh/ui/palette.dart';
...
void main() {
  ...
  test('the mark is a zigzag folding', () {
    // The picture is a real three-eared folding, found by the
    // sweep and checked here.
    final play = Mark.zigzag;
