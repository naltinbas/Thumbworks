...
import 'package:stillmere/ui/mark.dart';
import 'package:stillmere/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the boat lying still, real and checked', () {
    // The picture is five lanterns in the boat, every one with two or
    // three lit neighbours and no dark spot with three.
    final play = Mark.boat;
    expect(play.isDone, isTrue);
    expect(play.lit, hasLength(5));
  });
