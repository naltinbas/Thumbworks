...
import 'package:bondwell/ui/mark.dart';
import 'package:bondwell/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the Talmud\'s three hundred row, and it hangs level', () {
    // The picture is 6, 12 and 18 coins, which is 50, 100 and 150 zuz.
    final play = Mark.large;
    expect(play.purses, [6, 12, 18]);
    expect(play.chest, 0);
    expect(play.allLevel, isTrue);
    expect(play.isDone, isTrue);
    expect(Rules.division(36), play.purses);
    expect(play.purses.map(Rules.tellZuz).toList(), ['50', '100', '150']);
  });
