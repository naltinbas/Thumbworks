          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Hits spread round a ring of steps as evenly as they can '
                  'go: the even rhythms are exactly the ones Euclid\'s rule '
                  'lays down, and three hits in eight steps never come out '
                  'with equal gaps.',
