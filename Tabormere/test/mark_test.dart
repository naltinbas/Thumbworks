...
import 'package:tabormere/ui/mark.dart';
import 'package:tabormere/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the tresillo, real and checked', () {
    // The picture is x..x..x., three hits in eight steps with gaps of 3,
    // 3 and 2: even, a turning of Euclid's, and The Tresillo is landed
    // by it.
    final play = Mark.tresillo;
    expect(play.hitsAt, [0, 3, 6]);
    expect(play.gaps, [3, 3, 2]);
    expect(Rules.isEven(8, play.hitsAt), isTrue);
    expect(Rules.evenByEuclid(8, 3), contains('0,3,6'));
