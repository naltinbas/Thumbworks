          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Even numbers split into two primes, Goldbach\'s way: every '
                  'even number from 4 to 2,000 splits, 100 six ways, and an '
                  'odd number without a 2 in it never does, since two odd '
                  'primes make an even one.',
