...
import 'package:evenholme/ui/mark.dart';
import 'package:evenholme/ui/palette.dart';
...
void main() {
  ...
  test('the mark is twenty split as 3 + 17, real and checked', () {
    // The picture is the slate of twenty with 3 picked and 17 lit, both
    // prime: The Twenty's own aim.
    final play = Mark.three;
    expect((play.picked, play.partner), (3, 17));
    expect(Rules.isPrime(3) && Rules.isPrime(17), isTrue);
