          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'The pirates and the gold: the captain divides ten coins '
                  'and the crew votes by what each would get with the captain '
                  'gone; five pirates, and the captain keeps eight, and never '
                  'nine.',
