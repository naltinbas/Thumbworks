...
import 'package:cutlassby/ui/mark.dart';
import 'package:cutlassby/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the five pirates paid, real and checked', () {
    // The picture is the best plan for five, eight, nought, one, nought,
    // one, voted and passed.
    final play = Mark.five;
    expect(play.isDone, isTrue);
    expect(play.shares, [8, 0, 1, 0, 1]);
  });
