...
import 'package:handfast/ui/mark.dart';
import 'package:handfast/ui/palette.dart';
...
void main() {
  ...
  test('the mark is a board really given out, up to the most there is', () {
    // Taken on through the same code a finger goes through, so the picture is
    // a board the game would call finished, on as many jobs as can be covered.
    final play = Mark.given;
    expect(play.isDone, isTrue);
    expect(play.isMost, isTrue);
    expect(play.covered, Mark.fair.jobs);
  });
