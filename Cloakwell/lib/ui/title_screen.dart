          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Coats jumbled on the hooks, swapped two neighbours at a '
                  'time: the fewest swaps to sort them is the count of pairs '
                  'out of order, and no swap changes that count by more than '
                  'one.',
