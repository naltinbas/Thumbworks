...
import 'package:cloakwell/ui/mark.dart';
import 'package:cloakwell/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the reverse of four as it hangs, real and checked', () {
    // The picture is 4, 3, 2, 1 on the hooks with all six pairs strung
    // askew above the rail.
    final play = Mark.reverse;
    expect(play.row, [4, 3, 2, 1]);
