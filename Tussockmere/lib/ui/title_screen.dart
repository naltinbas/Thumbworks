          ...
          child: Column(
            ...
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Step the tussocks and link west to east before '
                  'the mere links north to south.',
                  textAlign: TextAlign.center,
                  style: TextStyle(
              ...
              Expanded(
                child: ListView.separated(
                  ...
                  itemBuilder: (context, number) => _FieldRow(
                    number: number,
                    steps: best?.stepsFor(Fields.at(number).name),
...
class _FieldRow extends StatelessWidget {
  ...
  /// The fewest steps this field has been linked in, or null.
  final int? steps;
  ...
  Widget build(BuildContext context) {
    ...
    return Semantics(
      button: true,
      label: '${field.name}, ${field.size} by ${field.size}',
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        field.winnable
                            ? '${field.size} by ${field.size}, '
                                '${field.task}'
                            : '${field.size} by ${field.size}, '
                                '${field.task}: every line loses',
                        style: TextStyle(
                          color: field.winnable
                              ? Palette.inkDim
                              : Palette.bad,
                          fontSize: 12,
                        ),
