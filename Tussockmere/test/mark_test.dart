...
import 'package:tussockmere/ui/mark.dart';
import 'package:tussockmere/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the three-field linked bank to bank', () {
    // The mark goes through the same code a finger goes through, so
    // the picture is a marsh the solve itself linked.
    final play = Mark.opening;
    expect(play.field.name, 'The Three Field');
    expect(play.isDone, isTrue);
    expect(play.isLost, isFalse);
  });
