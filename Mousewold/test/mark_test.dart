...
import 'package:mousewold/ui/mark.dart';
import 'package:mousewold/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the barnyard with the chase standing', () {
    // The mark goes through the same code a finger goes through, so
    // the picture is a chase that can still be won.
    final play = Mark.opening;
    expect(play.ground.name, 'The Barnyard');
    expect(play.caught, isFalse);
    expect(play.toCatch, play.ground.rounds);
  });
