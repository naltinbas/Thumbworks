          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Nails round a hoop and a thread that skips: one stroke '
                  'threads them all exactly when the skip and the count '
                  'share no factor, so the six-pointed star takes two.',
