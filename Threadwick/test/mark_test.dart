...
import 'package:threadwick/ui/mark.dart';
import 'package:threadwick/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the star of David in its two strokes, real and checked', () {
    // The picture is six nails and a skip of two: two triangles, the
    // very thing The Star of David asks for in one stroke and cannot
    // have.
    final play = Mark.david;
    expect((play.nails, play.skip), (6, 2));
    expect(play.strokes, [
      [0, 2, 4],
      [1, 3, 5]
    ]);
    expect(Rules.strokesByDivisor(6, 2), 2);
