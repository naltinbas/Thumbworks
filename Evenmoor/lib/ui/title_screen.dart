          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Set pegs on the moor and see where the halfway posts '
                  'land: five pegs can never keep them all off the holes.',
              ...
              Expanded(
                child: ListView.builder(
                  itemCount: Peggings.count,
                  itemBuilder: (context, number) {
                    final pegging = Peggings.at(number);
                    final fewest = Best.fewest(pegging.name);
                    return ListTile(
                      leading: Text(
                        '${number + 1}',
                      ...
                      subtitle: Text(
                        '${pegging.task[0].toUpperCase()}${pegging.task.substring(1)}'
