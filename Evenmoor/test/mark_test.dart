...
import 'package:evenmoor/ui/mark.dart';
import 'package:evenmoor/ui/palette.dart';
...
void main() {
  ...
  test('the mark is five pegs with one post landed, real and checked', () {
    // The picture is one peg to each kind of hole in a corner block
    // and a fifth in the far corner, sharing a kind with the first,
    // so their halfway post lands in the middle of the moor.
    final play = Mark.five;
    expect(play.isDone, isTrue);
    expect(play.landed, [(0, 4)]);
    expect(play.kindsUsed, 4);
  });
