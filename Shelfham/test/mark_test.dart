...
import 'package:shelfham/ui/mark.dart';
import 'package:shelfham/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the stair down', () {
    // The picture is the one full-reverse shelf of four, found
    // by the sweep and checked here.
