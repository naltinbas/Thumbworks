          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Shelve the books and count the steps down: '
                  'Euler wrote the row before you did.',
              ...
              Expanded(
                child: ListView.builder(
                  itemCount: Shelves.count,
                  itemBuilder: (context, number) {
                    final shelf = Shelves.at(number);
                    final fewest = Best.fewest(shelf.name);
                    return ListTile(
                      leading: Text(
                        '${number + 1}',
                      ...
                      onTap: () async {
                        await Navigator.of(context).push(
                          MaterialPageRoute<void>(
                            builder: (_) => ShelfScreen(shelf: shelf),
                          ),
                        );
                        if (mounted) setState(() {});
                      },
