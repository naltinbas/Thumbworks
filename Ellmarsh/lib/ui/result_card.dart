...
/// The card under a settled bench.
class ResultCard extends StatelessWidget {
  ...
  String get _line {
    if (play.won) {
      ...
      return 'The last cut was yours$asked. Hold the other side inside '
          'the gap, and the bench never leaves you.';
    }
    return 'The mercer made the last cut. Somewhere back up the cloth, a '
        'cut left the bolts inside the gap on your turn, and from there '
        'the walk was forced.';
  }
  ...
  Widget build(BuildContext context) => Padding(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Semantics(
                label: play.won ? 'the bench is yours' : 'the bench is lost',
        ...
        child: GestureDetector(
          ...
          child: ExcludeSemantics(
            child: Container(
              height: 44,
              decoration: BoxDecoration(
                color: lit ? Palette.edge : Palette.shop,
