...
import 'package:cubewick/ui/mark.dart';
import 'package:cubewick/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the two-box tiled, real and checked', () {
    // The picture is the sweep's first tiling of the two-box, twelve
    // lozenges reading as cubes stacked in a box.
    final play = Mark.twoBox;
    expect(play.isDone, isTrue);
    expect(play.laid, hasLength(12));
  });
