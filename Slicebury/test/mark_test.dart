...
import 'package:slicebury/ui/mark.dart';
import 'package:slicebury/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the thirty-one, real and checked', () {
    // The picture is six candles cutting thirty-one: the
    // doubling broken on the cake itself.
    final play = Mark.thirtyOne;
