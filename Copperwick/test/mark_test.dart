...
import 'package:copperwick/ui/mark.dart';
import 'package:copperwick/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the ten turned, real and checked', () {
    // The picture is the ten pennies at the aim: the point at the bottom,
    // seven where they lay and three moved.
    final play = Mark.ten;
    expect(play.turned, isTrue);
    expect(play.moves, 3);
  });
