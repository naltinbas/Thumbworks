...
import 'package:evenholt/ui/mark.dart';
import 'package:evenholt/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the eight shared, real and checked', () {
    // The picture is Prouhet's share of eight, the one that
    // squares, dealt by the doubling pattern.
    final play = Mark.eight;
    expect(play.isDone, isTrue);
    expect(play.leftTray, [1, 4, 6, 7]);
  });
