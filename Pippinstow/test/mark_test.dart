...
import 'package:pippinstow/ui/mark.dart';
import 'package:pippinstow/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the tree at (3, 7), real and checked', () {
    // The picture is the orchard, and the line of sight to (3, 7): in
    // sight, three and seven sharing no factor, nothing in the way.
    final play = Mark.sight;
    expect(play.picked, (3, 7));
    expect(play.seen, isTrue);
    expect(play.between, isEmpty);
    expect(play.hides, isEmpty);
  });
