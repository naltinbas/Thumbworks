...
/// The card under a box that has been settled.
class ResultCard extends StatelessWidget {
  ...
  String get _line {
    final answer = play.answer!;
    final which = 'Coin ${answer.coin + 1} is the '
        '${answer.heavy ? 'heavy' : 'light'} one';
    if (play.isFewest) {
      return '$which, on ${play.weighings} weighings, and there is no way to '
          'be certain in fewer.';
    }
    return '$which, on ${play.weighings} weighings. It can be done in '
        '${pyx.fewest}.';
  }
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Expanded(child: _Button(label: 'Boxes', onTap: onLeave)),
                  const SizedBox(width: 9),
                  Expanded(
