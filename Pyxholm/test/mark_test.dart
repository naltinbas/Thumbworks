...
import 'package:pyxholm/ui/mark.dart';
import 'package:pyxholm/ui/palette.dart';
...
void main() {
  ...
  test('the mark is a weighing really made', () {
    // Put on the pans through the same code a finger goes through, so the
    // picture is a beam the game could actually have in front of it, and the
    // weighing told it something.
    final play = Mark.weighed;
    expect(play.weighings, 1);
    expect(play.told.first.weighing.isFair, isTrue);
    expect(play.standing.length, lessThan(Mark.pyx.verdicts));
  });
