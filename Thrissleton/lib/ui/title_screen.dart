          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Dial the stones and count the thirds: five '
                  'stones never carry none.',
              ...
              Expanded(
                child: ListView.builder(
                  itemCount: Hands.count,
                  itemBuilder: (context, number) {
                    final hand = Hands.at(number);
                    final fewest = Best.fewest(hand.name);
                    return ListTile(
                      leading: Text(
                        '${number + 1}',
                      ...
                      onTap: () async {
                        await Navigator.of(context).push(
                          MaterialPageRoute<void>(
                            builder: (_) => ThirdScreen(hand: hand),
                          ),
                        );
                        if (mounted) setState(() {});
                      },
