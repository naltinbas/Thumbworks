...
import 'package:thrissleton/ui/mark.dart';
import 'package:thrissleton/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the perfect ten, real and checked', () {
    // The picture is a hand of one remainder: all ten triples
    // washed green at once.
    final play = Mark.perfectTen;
