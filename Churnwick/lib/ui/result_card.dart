...
/// The card under a morning that has been measured out.
class ResultCard extends StatelessWidget {
  ...
  String get _line {
    final want = play.dairy.want;
    if (play.isFewest) {
      return '$want gallons standing, in ${play.goes} goes, and there is no '
          'way to do it in fewer.';
    }
    return '$want gallons standing, in ${play.goes} goes. It can be done in '
        '${morning.fewest}.';
  }
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Expanded(child: _Button(label: 'Mornings', onTap: onLeave)),
                  const SizedBox(width: 9),
                  Expanded(
