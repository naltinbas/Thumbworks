...
import 'package:churnwick/ui/mark.dart';
import 'package:churnwick/ui/palette.dart';
...
void main() {
  ...
  test('the mark is a morning really measured out, on the fewest', () {
    // Poured through the same code a finger goes through, so the picture is a
    // dairy the game would call finished, in as few goes as there are.
    final play = Mark.measured;
    expect(play.isDone, isTrue);
    expect(play.isFewest, isTrue);
    expect(play.standing, contains(Mark.dairy.want));
  });
