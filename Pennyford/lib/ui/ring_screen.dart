...
/// One ask, the two coins set to it.
...
class RingScreenState extends State<RingScreen> {
  ...
  String verdict() {
    ...
    if (play.gaveUp) return 'Equal coins take sixty degrees each: six fit exactly, a seventh never, and a bigger ring coin takes more.';
    final head = 'A middle of ${play.middle} and rings of ${play.ring}: each takes ${play.each.toStringAsFixed(1)} degrees, so ${play.fit} fit, '
        '${play.spare == 0 ? 'nothing to spare' : '${play.spare.toStringAsFixed(1)} degrees to spare'}.';
          ...
          child: Column(
            children: [
              Padding(
                ...
                child: Text(
                  'Size the middle coin and the ring coins a step a tap, and '
                  'see how many fit round: ${widget.level.task}.',
                  style: const TextStyle(
              ...
              if (!play.isOver)
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      _dial(0, 'middle', play.middle),
                      const SizedBox(width: 8),
                      _dial(1, 'ring', play.ring),
                    ],
                  ),
                ),
              if (!play.isOver)
                ...
                children: [
                  ...
                  Chip(
                    ...
                    side: BorderSide(
                        color: play.isDone ? Palette.good : Palette.line),
                    label: Text(
                      '${play.spare.toStringAsFixed(1)}° spare',
                      style: TextStyle(
                          color: play.spare == 0 ? Palette.ink : Palette.spare, fontSize: 13),
                    ),
                  ),
                  Chip(
                    backgroundColor: Palette.board,
