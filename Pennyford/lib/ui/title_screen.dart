          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Coins set touching a middle coin: six pennies fit round a '
                  'penny and never seven, since each takes a sixth of the '
                  'turn, and smaller coins fit by the count the angle allows.',
