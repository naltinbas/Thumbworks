...
///
/// Every ring in them was set by taps on the dials, so nothing in the
...
void main() {
  ...
  testWidgets('the six', (tester) async {
  ...
  testWidgets('the seven', (tester) async {
  ...
  testWidgets('midway, ones round a six, on the small phone', (tester) async {
  ...
  testWidgets('the seven pennies admitted', (tester) async {
    await show(tester, phones['iphone-14']!, which: 4);
    await setDials(tester, 3, 3);
    expect(state(tester).play.gaveUp, isTrue);
    await shoot(tester, 'pennies');
  });
