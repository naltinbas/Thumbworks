...
import 'package:pennyford/ui/mark.dart';
import 'package:pennyford/ui/palette.dart';
...
void main() {
  ...
  test('the mark is six pennies round a penny, real and checked', () {
    // The picture is equal coins of two: six fit round the middle with
    // nothing to spare, and The Six is landed by it.
    final play = Mark.pennies;
    expect((play.middle, play.ring), (2, 2));
    expect(play.fit, 6);
    expect(play.spare, 0);
    expect(Rules.mostMeasured(2, 2), 6);
