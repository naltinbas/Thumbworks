...
import 'package:cupwell/ui/mark.dart';
import 'package:cupwell/ui/palette.dart';
...
void main() {
  ...
  test('the mark is one cup down of three, real and checked', () {
    // The picture is the tray twos never right: the middle cup down
    // between two up.
    final play = Mark.oneOfThree;
    expect(play.downCount, 1);
    expect(play.rules.fewest(play.tray), isNull);
  });
