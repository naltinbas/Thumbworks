...
import 'package:wheelford/ui/mark.dart';
import 'package:wheelford/ui/palette.dart';
...
void main() {
  ...
  test('the mark is a square corner across a diameter, real and checked', () {
    // The picture is three pegs on the rim, the corner at (3, 4)
    // square because the far cord runs through the hub.
    final play = Mark.rightCorner;
