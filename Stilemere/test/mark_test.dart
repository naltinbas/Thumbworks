...
import 'package:stilemere/ui/mark.dart';
import 'package:stilemere/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the stile passed, real and checked', () {
    // The picture is the three-by-three field walked over its stile,
    // the walk's first route.
    final play = Mark.stile;
