          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Walk the hedged field from the gate to the mill, right '
                  'or up only, over the stiles and round the ponds; every '
                  'route is counted at every junction.',
