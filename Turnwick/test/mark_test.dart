...
import 'package:turnwick/ui/mark.dart';
import 'package:turnwick/ui/palette.dart';
...
void main() {
  ...
  test('the mark is all four up, real and checked', () {
    // The picture is the four cards face up after turn, cut, cut, turn.
    final play = Mark.allUp;
