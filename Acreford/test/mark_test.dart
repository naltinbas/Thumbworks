...
import 'package:acreford/ui/mark.dart';
import 'package:acreford/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the half over, real and checked', () {
    // The picture is a real paddock found by the sweep: two
    // acres and a half, one post held and one caught mid-rail.
    final play = Mark.paddock;
    expect(play.isDone, isTrue);
    expect(play.twoA, 5);
    expect(play.inside, 1);
    expect(play.midRail, 1);
  });
