          ...
          child: Column(
            ...
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Braid the fleeces into one skein; every braid '
                  'costs its two bundles put together.',
                  textAlign: TextAlign.center,
                  style: TextStyle(
...
class _YardRow extends StatelessWidget {
  ...
  /// The fewest askings this yard has been braided with, or null.
  final int? askings;
