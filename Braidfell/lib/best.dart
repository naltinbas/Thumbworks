...
/// The fewest askings each yard's skein has been braided with.
///
...
/// yard nobody has braided. The fifty-nine writes nothing.
class Best {
  Best(this._prefs);

  final SharedPreferences _prefs;

  static const _prefix = 'braided.';
  ...
  /// Writes a braiding down, and says whether it beat what was there.
