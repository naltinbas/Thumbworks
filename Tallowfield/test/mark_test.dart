...
import 'package:tallowfield/ui/mark.dart';
import 'package:tallowfield/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the shared bed, all three hedges complaining', () {
    // The garden comes through the same painter an evening goes through,
    // and the complaints name the centre lamp.
    final play = Mark.tonight;
    expect(play.complaints, [true, true, true]);
    expect(play.named, 7);
  });
