...
import 'package:slantbury/ui/mark.dart';
import 'package:slantbury/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the frame laid, real and checked', () {
    // The picture is the sweep's first laying of the thirteen-by-five:
    // the four pieces inside, none overlapping, one square bare.
    final play = Mark.frame;
    expect(play.isDone, isTrue);
    expect(play.overlaps, isEmpty);
    expect(play.gap.toString(), '1');
  });
