...
import 'package:skittlemere/ui/mark.dart';
import 'package:skittlemere/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the first frame after the middle knock', () {
    // The pictured alley goes through the same code a finger goes
    // through, so the logo is a live game, not an arrangement.
    final play = Mark.middled;
    expect(play.segments, [2, 2]);
    expect(play.count, 0);
    expect(play.knocks, 1);
  });
