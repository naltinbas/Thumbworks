...
import 'package:hamperfen/ui/mark.dart';
import 'package:hamperfen/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the one six', () {
    // The picture is the middle shelf entire, the only family
    // of six the sweep ever finds.
    final play = Mark.six;
