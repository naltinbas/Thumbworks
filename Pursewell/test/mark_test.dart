...
import 'package:pursewell/ui/mark.dart';
import 'package:pursewell/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the forty-seven paid', () {
    // The picture is the one payment of 47, checked the same way
    // a finger's paying would be.
    final play = Mark.fortySeven;
    expect(play.isDone, isTrue);
    expect(play.tray.toSet(), {13, 34});
