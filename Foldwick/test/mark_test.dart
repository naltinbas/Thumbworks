...
import 'package:foldwick/ui/mark.dart';
import 'package:foldwick/ui/palette.dart';
...
void main() {
  ...
  test('the mark is a plank on the way across, real and checked', () {
    // The picture is three and three interleaved, goat sheep goat
    // sheep goat sheep, the empty pen at the end: reachable, and a
    // crossing runs on from it.
    final play = Mark.midway;
