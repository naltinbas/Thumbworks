...
import 'package:meetingham/ui/mark.dart';
import 'package:meetingham/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the medians meeting, real and checked', () {
    // The picture is the field with every gate at its middle: the three
    // medians meet at (4, 4), The Medians' own aim.
    final play = Mark.medians;
    expect(play.gates, [6, 6, 6]);
