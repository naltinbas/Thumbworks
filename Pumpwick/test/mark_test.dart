...
import 'package:pumpwick/ui/mark.dart';
import 'package:pumpwick/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the five houses with the pump at the middle', () {
    final play = Mark.middle;
    expect(play.spot, 5);
    expect(play.houses, [2, 3, 5, 8, 12]);
    expect(play.walk, 15);
    expect(play.walk, play.least);
    expect(Rules.bestSpots(play.houses), [5]);
