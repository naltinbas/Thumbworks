...
import 'package:loafham/ui/mark.dart';
import 'package:loafham/ui/palette.dart';
...
void main() {
  ...
  test('the mark is four fifths cut the greedy way, real and checked', () {
    // The picture is a half, a quarter and a twentieth: the Rhind
    // papyrus cut, and the sweep's first way.
    final play = Mark.fourFifths;
    expect(play.isDone, isTrue);
    expect(play.cuts, [2, 4, 20]);
  });
