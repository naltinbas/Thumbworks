...
import 'package:riffleford/ui/mark.dart';
import 'package:riffleford/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the odd cut riffled sloppily, real and checked', () {
    // The picture is a full riffle of the odd cut, three from the
    // first pile, and every pair mixed all the same.
    final play = Mark.oddCut;
    expect(play.isDone, isTrue);
    expect(play.blocks, [true, true, true, true]);
  });
