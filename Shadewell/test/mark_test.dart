...
import 'package:shadewell/ui/mark.dart';
import 'package:shadewell/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the well, shaded home', () {
    // The pictured marks go through the same code a finger goes
    // through, so the logo is a live game, not an arrangement.
    final play = Mark.shaded;
    expect(play.isDone, isTrue);
    expect(play.fallenRows, isEmpty);
    expect(play.fallenCols, isEmpty);
  });
