...
import 'package:kerbwell/ui/mark.dart';
import 'package:kerbwell/ui/palette.dart';
...
void main() {
  ...
  test('the mark is eight slabs in a kerb of twelve, real and checked', () {
    // The picture is the three by three less a corner, kerb twelve.
    final play = Mark.eight;
    expect(play.isDone, isTrue);
    expect(play.kerb, 12);
    expect(play.joined, isTrue);
  });
