...
import 'package:beadlow/ui/mark.dart';
import 'package:beadlow/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the three-bead ring, shelf full', () {
    // The mark goes through the same code a finger goes through, so
    // the picture is a shelf a test fills itself.
    final play = Mark.opening;
    expect(play.ring.name, 'The Three');
