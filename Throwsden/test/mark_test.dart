...
import 'package:throwsden/ui/mark.dart';
import 'package:throwsden/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the four lined up, real and checked', () {
    // The picture is Ash, Dane, Cole and Bram in a line, each having
    // thrown the next, the walk's first line of The Four.
    final play = Mark.four;
    expect(play.isDone, isTrue);
    expect(play.line, [0, 3, 2, 1]);
  });
