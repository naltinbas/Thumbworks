...
class ResultCard extends StatelessWidget {
  ...
  String get _line {
    ...
    if (play.yard.closed) {
      return 'Every paddock once and home a jump away$asked.';
    }
    return 'Every paddock exactly once$asked.';
  }
        ...
        child: GestureDetector(
          ...
          child: ExcludeSemantics(
            child: Container(
              height: 44,
              decoration: BoxDecoration(
                color: lit ? Palette.edge : Palette.beyond,
