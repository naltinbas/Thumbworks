...
import 'package:cutmere/ui/mark.dart';
import 'package:cutmere/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the eight found in three, real and checked', () {
    // The picture is the eight casks cut in the middle three times, the
    // cellarman keeping the right, the coin in the last cask.
