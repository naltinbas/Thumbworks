...
/// The card under a standing stack.
class ResultCard extends StatelessWidget {
  ...
  String get _line {
    ...
    return 'Every side of the stack shows all four paints$asked: '
        '${play.consignment.ways} way'
        '${play.consignment.ways == 1 ? '' : 's'} in the 1,296, and '
        'this is one of them.';
  }
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Expanded(child: _Button(label: 'Yard', onTap: onLeave)),
                  const SizedBox(width: 9),
                  Expanded(
