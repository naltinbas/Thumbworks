...
import 'package:fairhold/ui/mark.dart';
import 'package:fairhold/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the easy lading, stacked and standing', () {
    // The choices are a real solution applied through the same code a
    // finger goes through.
    final play = Mark.standing;
    expect(play.isStacked, isTrue);
  });
