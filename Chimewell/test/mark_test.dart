...
import 'package:chimewell/ui/mark.dart';
import 'package:chimewell/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the comma, real and checked', () {
    // The picture is twelve fifths stacked up the coil and dropped seven
    // octaves: 531,441 over 524,288, 23.46 cents sharp of the start, and
    // The Circle's own landing.
    final play = Mark.comma;
    expect((play.fifths, play.octaves), (12, -7));
    expect(play.note, (BigInt.from(531441), BigInt.from(524288)));
    expect(Rules.within(play.note, 20), isTrue);
