...
/// The card under a round that is home.
class ResultCard extends StatelessWidget {
  ...
  String get _line {
    if (play.isShortest) {
      return '${play.length} furlongs, and there is no shorter round.';
    }
    return '${play.length} furlongs. The shortest is '
        '${play.round.shortest}, so that was ${play.over} further than it '
        'had to be.';
  }
  ...
  Widget build(BuildContext context) => Padding(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color: play.isShortest ? Palette.good : Palette.edge,
              width: 1.2,
            ),
          ),
          child: Column(
            ...
            children: [
              ...
              Text(
                ...
                textAlign: TextAlign.center,
                style: TextStyle(
                  color: play.isShortest ? Palette.good : Palette.inkDim,
                  fontSize: 13,
                  height: 1.3,
                ),
              ),
