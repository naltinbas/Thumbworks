...
import 'package:pailsworth/ui/mark.dart';
import 'package:pailsworth/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the springside four, three pours in', () {
    // The pictured waterlines go through the same code a finger goes
