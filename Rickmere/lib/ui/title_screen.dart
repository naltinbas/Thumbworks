          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Raise a hayrick on each side of a field and mark the '
                  'middle of each. However the posts stand, the three '
                  'markers make a perfectly even triangle.',
                      ...
                      onTap: () async {
                        await Navigator.of(context).push(
                          MaterialPageRoute<void>(
                            builder: (_) => RickScreen(level: level),
                          ),
                        );
                        if (mounted) setState(() {});
                      },
