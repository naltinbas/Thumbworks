...
import 'package:bridgeholm/ui/mark.dart';
import 'package:bridgeholm/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the mill round, two bridges in', () {
    // The pictured walk goes through the same code a finger goes
    // through, so the logo is a live game, not an arrangement.
    var play = Mark.twoIn;
    expect(play.crossed, 2);
