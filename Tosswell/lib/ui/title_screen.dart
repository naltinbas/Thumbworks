          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Five tosses of a fair coin, and any rule you like for '
                  'walking away with what you have. The purse averages '
                  'nothing, whichever rule you write.',
                      ...
                      onTap: () async {
                        await Navigator.of(context).push(
                          MaterialPageRoute<void>(
                            builder: (_) => TossScreen(level: level),
                          ),
                        );
                        if (mounted) setState(() {});
                      },
