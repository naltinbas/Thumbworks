...
import 'package:ringfold/ui/mark.dart';
import 'package:ringfold/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the five-hour clock walked, real and checked', () {
    // The picture is the Fibonacci numbers round the five-hour clock,
    // twenty steps and home: The Twenty's aim.
    final play = Mark.five;
    expect(play.clock, 5);
    expect(play.period, 20);
    expect(Rules.periodByMatrix(5), 20);
    expect(play.cycle.take(6).toList(), [0, 1, 1, 2, 3, 0]);
