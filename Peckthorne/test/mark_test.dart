...
import 'package:peckthorne/ui/mark.dart';
import 'package:peckthorne/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the full court, real and checked', () {
    // The picture is the round pecking of five: every chicken
    // pecks the next two, and every one wears a crown.
    final play = Mark.court;
    expect(play.isDone, isTrue);
    expect(play.kings, hasLength(5));
    expect(play.emperors, isEmpty);
  });
