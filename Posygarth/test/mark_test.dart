...
import 'package:posygarth/ui/mark.dart';
import 'package:posygarth/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the four beds, bloomed sound', () {
    // Every posy went in through the same code a finger goes through.
    final play = Mark.bloomed;
    expect(play.isBloomed, isTrue);
    expect(play.planted, 16);
  });
