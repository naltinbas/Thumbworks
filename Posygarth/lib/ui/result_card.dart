...
/// The card under a bloomed garth.
class ResultCard extends StatelessWidget {
  ...
  String get _line {
    ...
    return 'Every line fair and every pairing fresh$asked: two Latin '
        'squares in one garden, which is all the officers ever wanted.';
  }
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Expanded(child: _Button(label: 'Garths', onTap: onLeave)),
                  const SizedBox(width: 9),
                  Expanded(
