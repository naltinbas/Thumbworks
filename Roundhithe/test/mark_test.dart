...
import 'package:roundhithe/ui/mark.dart';
import 'package:roundhithe/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the threes-and-threes plan, real and checked', () {
    // The picture is AD, AE, AF, BD, BE, BF, CD, CE, CF: three roads at
    // every village, and the round trip A D B E C F.
    final play = Mark.threes;
    expect(Rules.tell(play.roads), 'AD, AE, AF, BD, BE, BF, CD, CE, CF');
    expect(play.degrees, [3, 3, 3, 3, 3, 3]);
    expect(play.trip, [0, 3, 1, 4, 2, 5]);
    expect(play.tripByTable, isTrue);
