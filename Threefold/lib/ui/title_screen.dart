          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'A point on an equilateral green and its three distances '
                  'to the sides: they add up to the height wherever it '
                  'stands, Viviani\'s theorem, checked by areas on every point '
                  'of the lattice.',
