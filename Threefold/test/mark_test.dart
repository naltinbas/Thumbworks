...
import 'package:threefold/ui/mark.dart';
import 'package:threefold/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the walker at 2, 4 and 6, real and checked', () {
    // The picture is the green with the walker two, four and six rungs
    // from the sides, the three distances drawn: The Doubles' own aim.
    final play = Mark.walker;
    expect(play.at, (2, 4, 6));
    expect(Rules.rungsAdded(play.at), 12);
    expect(Rules.areas(play.at), (48, 96, 144));
