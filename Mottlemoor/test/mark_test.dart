...
import 'package:mottlemoor/ui/mark.dart';
import 'package:mottlemoor/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the even herd one meeting in', () {
    // The pictured herds go through the same code a finger goes
    // through, so the logo is a live game, not an arrangement.
    var play = Mark.oneIn;
    expect(play.herds, (1, 1, 4));
    expect(play.fewestFromHere, 1);
    play = play.meet(play.next!.$1, play.next!.$2);
