          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Four tenants who own the cottage they live in, and any '
                  'group of them may trade among themselves. Exactly one '
                  'lane of swaps is one that no group can better.',
                      ...
                      onTap: () async {
                        await Navigator.of(context).push(
                          MaterialPageRoute<void>(
                            builder: (_) => FlitScreen(level: level),
                          ),
                        );
                        if (mounted) setState(() {});
                      },
