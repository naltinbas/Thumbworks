...
/// The card under a night where no lane is dark.
class ResultCard extends StatelessWidget {
  ...
  String get _line {
    ...
    if (play.isFewest) {
      return 'Every lane watched on $standing shepherds, and fewer cannot '
          'do it.';
    }
    return 'Every lane watched on $standing shepherds. It can be done on '
        '${play.fold.fewest}.';
  }
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Expanded(child: _Button(label: 'Folds', onTap: onLeave)),
                  const SizedBox(width: 9),
                  Expanded(
