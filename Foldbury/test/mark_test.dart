...
import 'package:foldbury/ui/mark.dart';
import 'package:foldbury/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the seven gates watched on its fewest', () {
    // Every shepherd stands where the search posts them, through the same
    // code a finger goes through, so the picture is a night that is safe.
    final play = Mark.safe;
    expect(play.isDone, isTrue);
    expect(play.standing, play.fold.fewest);
