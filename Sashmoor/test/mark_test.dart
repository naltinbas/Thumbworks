...
import 'package:sashmoor/ui/mark.dart';
import 'package:sashmoor/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the nine landed', () {
    // The picture is a real glazing at the big sash's limit,
    // checked the same way a finger's setting would be.
