          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Glaze the sash without framing a window: four '
                  'panes on a rectangle\'s corners are one too '
                  'many.',
              ...
              Expanded(
                child: ListView.builder(
                  itemCount: Sashes.count,
                  itemBuilder: (context, number) {
                    final sash = Sashes.at(number);
                    final fewest = Best.fewest(sash.name);
                    return ListTile(
                      leading: Text(
                        '${number + 1}',
                      ...
                      onTap: () async {
                        await Navigator.of(context).push(
                          MaterialPageRoute<void>(
                            builder: (_) => PaneScreen(sash: sash),
                          ),
                        );
                        if (mounted) setState(() {});
                      },
