          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Kings on a chequered board, none to touch another: the '
                  'most is the count of two-by-two blocks the board cuts '
                  'into, half the side rounded up and squared, and the even '
                  'squares always seat that many.',
