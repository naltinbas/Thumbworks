...
import 'package:crownwick/ui/board_screen.dart';
import 'package:crownwick/ui/boardview.dart';
...
Future<void> open(
  ...
  await tester.pumpWidget(const CrownwickApp());
...
/// Sets every king as the pointer says.
