...
import 'package:crownwick/ui/app.dart';
import 'package:crownwick/ui/mark.dart';
import 'package:crownwick/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the five by five seated, real and checked', () {
    // The picture is nine kings on the even squares of the five by five,
    // none touching another.
    final play = Mark.fiveByFive;
