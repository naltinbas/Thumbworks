...
import 'package:peckhollow/ui/mark.dart';
import 'package:peckhollow/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the ring of three, every bird crowned', () {
    // The mark goes through the same code a finger goes through, so
    // the picture is a crowning a test lands itself.
    final play = Mark.opening;
    expect(play.yard.name, 'The Three');
