...
import 'package:riddlecombe/ui/mark.dart';
import 'package:riddlecombe/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the three strands, woven clean', () {
    // The pictured weave goes through the same code a finger goes
    // through, so the logo is a live game, not an arrangement.
    final play = Mark.woven;
    expect(play.isClean, isTrue);
    expect(play.placed, 3);
