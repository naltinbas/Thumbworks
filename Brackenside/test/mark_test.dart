...
import 'package:brackenside/ui/mark.dart';
import 'package:brackenside/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the one eleven-patch planting', () {
    // The picture is the single planting in 729 that lands
    // eleven, found by the sweep and checked here.
    final play = Mark.eleven;
    expect(play.patches, 11);
