...
import 'package:leystone/ui/mark.dart';
import 'package:leystone/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the six stones standing', () {
    // The mark goes through the same code a finger goes through, so
    // the picture is a ring the search itself raised.
    final play = Mark.opening;
    expect(play.green.name, 'The Six Stones');
