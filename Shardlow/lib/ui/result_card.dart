...
/// The card under a morning that has settled.
class ResultCard extends StatelessWidget {
  ...
  String get _line {
    final answer = play.answer == 0
        ? 'No rung is safe at all'
        : 'The highest safe rung is ${play.answer}';
    if (play.isFewest) {
      return '$answer, settled in ${play.made} drops, and fewer could not '
          'always have done it.';
    }
    return '$answer, settled in ${play.made} drops. It can be done in '
        '${play.ladder.fewest}.';
  }
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Expanded(child: _Button(label: 'The yard', onTap: onLeave)),
                  const SizedBox(width: 9),
                  Expanded(
