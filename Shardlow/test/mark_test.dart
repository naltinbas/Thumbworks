...
import 'package:shardlow/ui/mark.dart';
import 'package:shardlow/ui/palette.dart';
...
void main() {
  ...
  test('the mark is a morning two sound drops in', () {
    // Both drops follow the table through the same code a finger goes
    // through, and the morning is still at par.
    final play = Mark.twoIn;
    expect(play.made, 2);
    expect(play.isDone, isFalse);
    expect(play.couldFinishIn, play.ladder.fewest);
  });
