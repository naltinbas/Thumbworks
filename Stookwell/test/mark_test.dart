...
import 'package:stookwell/ui/mark.dart';
import 'package:stookwell/ui/palette.dart';
...
void main() {
  ...
  test('the mark is seven sheaves in stooks apart, real and checked', () {
    // The picture is 4, 2 and 1, all apart, where Glaisher's turn
    // sends seven ones.
    final play = Mark.seven;
    expect(play.isDone, isTrue);
    expect(play.parts, [4, 2, 1]);
  });
