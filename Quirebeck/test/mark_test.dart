...
import 'package:quirebeck/ui/mark.dart';
import 'package:quirebeck/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the fifth leaf one weave into its word', () {
    // The mark goes through the same code a button goes through, so
    // the picture is a weaving a test finishes.
    final play = Mark.opening;
    expect(play.quire.name, 'The Fifth Leaf');
    expect(play.weaves, 1);
    expect(play.isDone, isFalse);
    expect(play.toDone, 2);
  });
