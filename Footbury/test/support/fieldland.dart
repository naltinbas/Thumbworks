...
import 'package:footbury/ui/foot_screen.dart';
import 'package:footbury/ui/footview.dart';
...
Future<void> open(
  ...
  await tester.pumpWidget(const FootburyApp());
...
FootScreenState state(WidgetTester tester) =>
    tester.state<FootScreenState>(find.byType(FootScreen));
