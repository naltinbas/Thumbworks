...
import 'package:marchcombe/ui/mark.dart';
...
void main() {
  ...
  test('the mark is a map really painted, on the fewest', () {
    // Painted through the same code a finger goes through, so the picture is
    // a map the game would call finished, on as few dyes as there are.
    final play = Mark.painted;
    expect(play.isDone, isTrue);
    expect(play.isFewest, isTrue);
    expect(play.used, hasLength(play.fewest));
    expect(Mark.land.isProper(play.dyes), isTrue);
  });
