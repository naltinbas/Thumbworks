...
/// The card under an estate that is painted.
class ResultCard extends StatelessWidget {
  ...
  String get _line {
    final used = play.used.length;
    if (play.isFewest) {
      return 'Every field painted, on $used dyes, and there is no way to do '
          'it on fewer.';
    }
    return 'Every field painted, on $used dyes. It can be done on '
        '${estate.fewest}.';
  }
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Expanded(child: _Button(label: 'Estates', onTap: onLeave)),
                  const SizedBox(width: 9),
                  Expanded(
