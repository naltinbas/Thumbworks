...
import 'package:squarewell/ui/mark.dart';
import 'package:squarewell/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the base 3 on the seven-hour clock, real and checked', () {
    // The picture is the seven-hour clock with 1, 2 and 4 lit and the
    // base 3, with its opposite 4, landing on 2: The Two of Seven's aim.
    final play = Mark.seven;
    expect((play.clock, play.base, play.square), (7, 3, 2));
    expect(play.squares, {1, 2, 4});
