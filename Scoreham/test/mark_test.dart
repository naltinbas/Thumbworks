...
import 'package:scoreham/ui/mark.dart';
import 'package:scoreham/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the five marks, the good walk on show', () {
    // The mark goes through the same code a finger goes through, so
    // the picture is a walk a test takes itself.
    final play = Mark.opening;
    expect(play.ring.name, 'The Five Marks');
