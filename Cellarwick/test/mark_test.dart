...
import 'package:cellarwick/ui/mark.dart';
import 'package:cellarwick/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the two glasses after the pouring, real and checked', () {
    // The picture is ten of each and a spoon of five: 10/3 of a unit
    // each way, the biggest carry there is here, and equal.
    final play = Mark.glasses;
    expect(play.dials, [10, 10, 5]);
    expect(play.pouring, (Frac.of(10, 3), Frac.of(10, 3)));
    expect(Rules.accountHolds(play.pouring!), isTrue);
  });
