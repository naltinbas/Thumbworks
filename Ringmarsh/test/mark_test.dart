...
import 'package:ringmarsh/ui/mark.dart';
import 'package:ringmarsh/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the eight watch, set full', () {
    // The pictured ring goes through the same code a finger goes
    // through, so the logo is a live game, not an arrangement.
    final play = Mark.full;
    expect(play.isFull, isTrue);
    expect(play.clashes, isEmpty);
    expect(play.speltCount, 8);
  });
