...
class ResultCard extends StatelessWidget {
  ...
  String get _line {
    ...
    final ways = play.watch.ways;
    return 'Every watchword spelt once round the ring$asked. The '
        'sweep counts ${ways == 1 ? 'this the only ring that does '
            'it' : 'it one of $ways rings that do'}.';
  }
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Expanded(child: _Button(label: 'Watches', onTap: onLeave)),
                  const SizedBox(width: 9),
                  Expanded(
        ...
        child: GestureDetector(
          ...
          child: ExcludeSemantics(
            child: Container(
              height: 44,
              decoration: BoxDecoration(
                color: lit ? Palette.edge : Palette.marsh,
