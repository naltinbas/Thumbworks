...
import 'package:loadwick/ui/mark.dart';
import 'package:loadwick/ui/palette.dart';
...
void main() {
  ...
  test('the mark is D against A, real and checked', () {
    // The picture is die D picked against the house's A, twenty-four
    // rolls of thirty-six in green.
    final play = Mark.dAgainstA;
