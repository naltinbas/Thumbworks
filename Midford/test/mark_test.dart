...
import 'package:midford/ui/mark.dart';
import 'package:midford/ui/palette.dart';
...
void main() {
  ...
  test('the mark is a kite of pegs with a square inside, real and checked', () {
    // The picture is four pegs on the board's edges, diagonals crossing
    // square and of a length, so the midpoint figure is a square.
    final play = Mark.kite;
