          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Set four pegs in order, cord them round, and see the '
                  'figure their midpoints make: always a parallelogram.',
              ...
              Expanded(
                child: ListView.builder(
                  itemCount: Cordings.count,
                  itemBuilder: (context, number) {
                    final cording = Cordings.at(number);
                    final fewest = Best.fewest(cording.name);
                    return ListTile(
                      leading: Text(
                        '${number + 1}',
                      ...
                      subtitle: Text(
                        '${cording.task[0].toUpperCase()}${cording.task.substring(1)}'
