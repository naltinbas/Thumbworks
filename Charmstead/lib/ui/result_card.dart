...
class ResultCard extends StatelessWidget {
  ...
  String get _line {
    ...
    final ways = play.charm.ways;
    return 'Eight lines, eight fifteens$asked. The sweep counts '
        '${ways == 1 ? 'this the only charm honouring the pins' : 'it '
            'one of $ways honouring the pins'}.';
  }
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Expanded(child: _Button(label: 'Charms', onTap: onLeave)),
                  const SizedBox(width: 9),
                  Expanded(
        ...
        child: GestureDetector(
          ...
          child: ExcludeSemantics(
            child: Container(
              height: 44,
              decoration: BoxDecoration(
                color: lit ? Palette.edge : Palette.hearth,
