...
import 'package:charmstead/ui/mark.dart';
import 'package:charmstead/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the written row\'s one charm, held', () {
    // The pictured coins go through the same code a finger goes
    // through, so the logo is a live game, not an arrangement.
    final play = Mark.held;
    expect(play.isDone, isTrue);
    expect(play.broken, isEmpty);
    expect(play.laid[4], 5);
  });
