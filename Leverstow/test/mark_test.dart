...
import 'package:leverstow/ui/mark.dart';
import 'package:leverstow/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the famous loop, and it climbs', () {
    // The picture is A once and B twice, the loop Parrondo told it with.
    final play = Mark.famous;
    expect(play.loop, 'ABB');
    expect(play.climb, Frac.of(2416, 35601));
    expect(play.climb, Rules.climbByChain('ABB'));
    expect(play.isDone, isTrue);
    expect(play.purse.last.toDouble, closeTo(2.784, 0.001));
  });
