...
class ResultCard extends StatelessWidget {
  ...
  String get _line {
    ...
    return 'Every pair its own number apart$asked. This shelf can be set '
        '${play.level.ways} way${play.level.ways == 1 ? '' : 's'}, and '
        'this is one of them.';
  }
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Expanded(child: _Button(label: 'Shelves', onTap: onLeave)),
                  const SizedBox(width: 9),
                  Expanded(
        ...
        child: GestureDetector(
          ...
          child: ExcludeSemantics(
            child: Container(
              height: 44,
              decoration: BoxDecoration(
                color: lit ? Palette.edge : Palette.floor,
