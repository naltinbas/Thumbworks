...
import 'package:spanham/ui/mark.dart';
import 'package:spanham/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the four pairs, set true', () {
    // Every block sits where the search put it, through the same code a
    // finger goes through, and every pair holds its number apart.
    final play = Mark.set;
    ...
    for (final density in densities.entries) {
      ...
      await drawTo(
        ...
        Padding(
          ...
          child: const Mark(onToybox: false),
        ),
      );
    }
