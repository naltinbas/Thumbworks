...
import 'package:wickthorn/ui/mark.dart';
import 'package:wickthorn/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the seven ropes closed', () {
    // The picture is a real closing, every pair on exactly one
    // rope, checked the same way a finger's stringing would be.
    final play = Mark.closing;
    expect(play.isDone, isTrue);
    expect(play.clashes, isEmpty);
    expect(play.rules.standings(play.ropes), everyElement(3));
  });
