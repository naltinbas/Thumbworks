          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Queens set to watch every square of a board: five watch '
                  'the whole chessboard, 4,860 ways, and four never do, '
                  'every one of the 635,376 placings leaving a square unseen.',
