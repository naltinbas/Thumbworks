...
import 'package:queenscote/ui/mark.dart';
import 'package:queenscote/ui/palette.dart';
...
void main() {
  ...
  test('the mark is five queens watching the chessboard, real and checked', () {
    // The picture is The Chessboard's aim, the picking's first watching
    // set of five: a8 b8 f7 a4 e3, every square seen.
    final play = Mark.five;
    expect(play.placed, [0, 1, 13, 32, 44]);
    expect(play.unseen, 0);
    expect(Rules.watches(8, play.placed), isTrue);
