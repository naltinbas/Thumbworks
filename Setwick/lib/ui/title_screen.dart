          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Pair the dancers off so every pair, multiplied, '
                  'comes to one over the caller\'s number.',
              ...
              Expanded(
                child: ListView.builder(
                  itemCount: Dances.count,
                  itemBuilder: (context, number) {
                    final dance = Dances.at(number);
                    final fewest = Best.fewest(dance.name);
                    return ListTile(
                      leading: Text(
                        '${number + 1}',
                      ...
                      subtitle: Text(
                        '${dance.task[0].toUpperCase()}${dance.task.substring(1)}'
