...
import 'package:setwick/ui/mark.dart';
import 'package:setwick/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the set of eleven paired off, real and checked', () {
    // The picture is Bezout's pairing of the eleven, four threads
    // all come to one.
    final play = Mark.eleven;
    expect(play.isDone, isTrue);
    expect(play.couples, [(2, 6), (3, 4), (5, 9), (7, 8)]);
  });
