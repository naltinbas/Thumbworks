          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Brick the yard course by course: the '
                  'six-square always cracks somewhere.',
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, number) {
                    ...
                    final fewest = Best.fewest(yard.name);
                    return ListTile(
                      leading: Text(
                        '${number + 1}',
                      ...
                      subtitle: Text(
                        '${yard.task[0].toUpperCase()}${yard.task.substring(1)}'
                      ...
                      onTap: () async {
                        await Navigator.of(context).push(
                          MaterialPageRoute<void>(
                            builder: (_) => CourseScreen(yard: yard),
                          ),
                        );
                        if (mounted) setState(() {});
                      },
