...
import 'package:coursewell/ui/mark.dart';
import 'package:coursewell/ui/palette.dart';
...
void main() {
  ...
  test('the mark is a sound course, real and checked', () {
    // The picture is a real laying found by the sweep: five by
    // six bricked whole with not one seam.
    final play = Mark.sound;
    expect(play.isDone, isTrue);
    expect(play.laid, hasLength(15));
