...
import 'package:rackenford/ui/mark.dart';
import 'package:rackenford/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the dozen by heights, real and checked', () {
    // The picture is Mirsky's own racking: every jar on the
    // rack of its longest chain, four racks, no quarrel.
    final play = Mark.dozen;
