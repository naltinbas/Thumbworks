...
import 'package:rowsworth/ui/mark.dart';
import 'package:rowsworth/ui/palette.dart';
...
void main() {
  ...
  test('the mark is sixty picked, real and checked', () {
    // The picture is sixty, the smallest heap with twelve even rows,
    // its divisor grid below.
    final play = Mark.sixty;
