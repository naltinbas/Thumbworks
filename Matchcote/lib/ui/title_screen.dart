...
import 'cote_screen.dart';
import 'mark.dart';
import 'palette.dart';

/// The fence, stile by cote.
          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Pair the players round by round: an odd '
                  'crowd never fills a single one.',
              ...
              Expanded(
                child: ListView.builder(
                  itemCount: Cotes.count,
                  itemBuilder: (context, number) {
                    final cote = Cotes.at(number);
                    final fewest = Best.fewest(cote.name);
                    return ListTile(
                      leading: Text(
                        '${number + 1}',
                      ...
                      onTap: () async {
                        await Navigator.of(context).push(
                          MaterialPageRoute<void>(
                            builder: (_) => CoteScreen(cote: cote),
                          ),
                        );
                        if (mounted) setState(() {});
                      },
