...
import 'package:matchcote/ui/mark.dart';
import 'package:matchcote/ui/palette.dart';
...
void main() {
  ...
  test('the mark is a full fixture of six', () {
    // The picture is a real fixture found by the sweep, every
    // pair met exactly once.
    final play = Mark.fixture;
    expect(play.isDone, isTrue);
    expect(play.rounds, hasLength(5));
  });
