...
import 'package:slateford/ui/mark.dart';
import 'package:slateford/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the open slate played level, real and checked', () {
    // The picture is the game the tree plays against the book from
    // the open slate: five crosses, four noughts, no line made.
    final play = Mark.level;
