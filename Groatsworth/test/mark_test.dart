...
import 'package:groatsworth/ui/mark.dart';
import 'package:groatsworth/ui/palette.dart';
...
void main() {
  ...
  test('the mark is four bob really paid, in the fewest', () {
    // Paid through the same code a finger goes through, so the picture is a
    // tray the game would call served: two florins, and no fewer can reach
    // four shillings.
    final play = Mark.paid;
    expect(play.isDone, isTrue);
    expect(play.isFewest, isTrue);
    expect(play.used, 2);
    expect(play.onTray(4), 2);
  });
