...
/// The card under an amount that has been met.
class ResultCard extends StatelessWidget {
  ...
  String get _line {
    final coins = play.used == 1 ? 'one coin' : '${play.used} coins';
    if (play.isFewest) {
      return '${play.round.spoken} counted out in $coins, and fewer cannot '
          'reach it.';
    }
    return '${play.round.spoken} counted out in $coins. It can be done in '
        '${play.round.fewest}.';
  }
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Expanded(child: _Button(label: 'The book', onTap: onLeave)),
                  const SizedBox(width: 9),
                  Expanded(
