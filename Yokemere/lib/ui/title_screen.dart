          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Yoke two rows of oxen one to one. Pairing strongest with '
                  'strongest pulls hardest of all, and a swap is the whole '
                  'reason why.',
                      ...
                      onTap: () async {
                        await Navigator.of(context).push(
                          MaterialPageRoute<void>(
                            builder: (_) => YokeScreen(level: level),
                          ),
                        );
                        if (mounted) setState(() {});
                      },
