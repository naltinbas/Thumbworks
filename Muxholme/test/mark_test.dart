...
import 'package:muxholme/ui/mark.dart';
import 'package:muxholme/ui/palette.dart';
...
void main() {
  ...
  test('the mark is MUIIU derived, real and checked', () {
    // The picture is MUIIU in tiles under its target, five steps from MI.
    final play = Mark.muiiu;
    expect(play.isDone, isTrue);
    expect(play.string, 'MUIIU');
  });
