          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Braess\'s paradox: two ways from Start to End, a shortcut '
                  'between them, and a crowd that settles where no driver '
                  'gains by switching; open the shortcut and, past thirty '
                  'hundred, everyone takes longer.',
