...
import 'package:shortcombe/ui/mark.dart';
import 'package:shortcombe/ui/palette.dart';
...
void main() {
  ...
  test('the mark is forty hundred with the shortcut open, real and checked', () {
    // The picture is the map with all forty hundred going top, across and
    // bottom, 80 minutes each: The Eighty's aim.
    final play = Mark.eighty;
    expect((play.crowd, play.open), (40, true));
    expect(play.settled, (0, 0, 40));
    expect(play.journey, 80);
