...
import 'package:fusewick/ui/mark.dart';
import 'package:fusewick/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the forty-five at its half hour, real and checked', () {
    // The picture is thirty minutes in: one fuse burnt out, the other lit
    // at both ends with half an hour of fuse left, fifteen minutes to go.
    final play = Mark.fortyFive;
    expect(play.now, 120);
    expect(play.nextBurnout, 60);
    expect(play.burn().isDone, isTrue);
  });
