          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Fuses that burn an hour end to end, unevenly, and a time '
                  'to strike by lighting ends: forty-five with two, fifty-two '
                  'and a half with three, and never twenty.',
