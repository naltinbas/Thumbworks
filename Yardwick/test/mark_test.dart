...
import 'package:yardwick/ui/mark.dart';
import 'package:yardwick/ui/palette.dart';
...
void main() {
  ...
  test('the mark is the hedges of thirty and twelve, real and checked', () {
    // The picture is the hedges of counts 30 and 12, 832,040 and 144
    // long, and the yardstick of 8, the sixth hedge.
    final play = Mark.thirtyTwelve;
    expect((play.first, play.second), (30, 12));
    expect(play.firstHedge, BigInt.from(832040));
    expect(play.secondHedge, BigInt.from(144));
    expect(play.measure, BigInt.from(8));
    expect(play.measureByCounts, BigInt.from(8));
    expect(play.commonCount, 6);
  });
