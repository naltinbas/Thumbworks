...
void main() {
  ...
  for (final phone in phones.entries) {
    ...
    testWidgets('the long yardstick on ${phone.key}', (tester) async {
      await show(tester, phone.value, which: 3);
      await setCounts(tester, 30, 15);
      expect(state(tester).play.isDone, isTrue);
      await shoot(tester, 'long-${phone.key}');
    });
  }

  testWidgets('the yardstick of five', (tester) async {
    await show(tester, phones['iphone-14']!, which: 0);
    await setCounts(tester, 25, 15);
    expect(state(tester).play.isDone, isTrue);
    await shoot(tester, 'five');
  });

  testWidgets('the sly pair', (tester) async {
  ...
  testWidgets('the whole measure', (tester) async {
  ...
  testWidgets('the odd share admitted', (tester) async {
    await show(tester, phones['iphone-14']!, which: 4);
