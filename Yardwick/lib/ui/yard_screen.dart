...
/// One ask, the two counts on their dials and the hedges they grow.
...
class YardScreenState extends State<YardScreen> {
  ...
  String verdict() {
    ...
    final head = 'Counts ${play.first} and ${play.second}: hedges ${Rules.tell(play.firstHedge)} and ${Rules.tell(play.secondHedge)}, yardstick ${Rules.tell(play.measure)}, the counts measuring by ${play.commonCount}.';
    if (play.gaveUp) return '$head As the counts go, so go the hedges.';
          ...
          child: Column(
            children: [
              Padding(
                ...
                child: Text(
                  'Step the two counts, one to thirty, and watch the hedges '
                  'grow and the yardstick that measures both: '
                  '${widget.level.task}.',
                  style: const TextStyle(
              ...
              Wrap(
                ...
                children: [
                  Chip(
                    ...
                    label: Text(
                      'yardstick ${Rules.tell(play.measure)}',
                      style: const TextStyle(
                  ...
                  Chip(
                    ...
                    side: BorderSide(
                        color: play.isDone ? Palette.good : Palette.line),
                    label: Text(
                      'counts measure by ${play.commonCount}',
                      style: const TextStyle(
