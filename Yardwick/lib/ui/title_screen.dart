          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Two hedges of Fibonacci length and the longest yardstick '
                  'that measures both: it is the Fibonacci number of the '
                  'counts\' common measure, as Lucas said, every pair measured.',
